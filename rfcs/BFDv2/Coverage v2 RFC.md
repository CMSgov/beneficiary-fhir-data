...
BFD proposes to provide a new v2 endpoint to support Coverage FHRI-R4 and CARIN complaint resource. 
...
1. Can raw un-hashed MBI be used a Subscriber Id?
...
A code from above code system below and if this can be used?
