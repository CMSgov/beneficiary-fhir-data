        ...
        "blocks": [
            {
                ...
                "text": {
                    ...
                    "text": (
                        ...
                        f"For help troubleshooting, reference the following [runbook](https://github.com/CMSgov/beneficiary-fhir-data/blob/master/runbooks/how-to-investigate-firehose-ingestion-processing-failures.md)\n"
                    ),
                },
            }
        ]
