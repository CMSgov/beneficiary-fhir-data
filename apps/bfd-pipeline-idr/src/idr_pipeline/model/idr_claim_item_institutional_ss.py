    ...
    def fetch_query(cls, partition: LoadPartition, start_time: datetime, source: Source) -> str:
        ...
        return f"""
                ...
                claims as (
                    ...
                    UNION
                    {clm_child_query(SETTINGS.idr_claim_line_fiss_table)}
                    UNION
                    {clm_child_query(SETTINGS.idr_claim_line_fiss_benefit_table)}
                ),
                ...
                claim_line_fiss_bnft_svg AS {not_materialized} (
                    ...
                    FROM {SETTINGS.idr_claim_line_fiss_benefit_table} {line_fiss_bnft}
                    JOIN claims {clm}
                ...
                LEFT JOIN {SETTINGS.idr_claim_line_fiss_table} {line_fiss}
