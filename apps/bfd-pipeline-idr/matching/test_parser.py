...
class TestProjectUsatParser(unittest.TestCase):
    ...
    def test_po_box(self):
        ...
        self.assertIn("PO BOX 11890", res)
        self.assertIn("SAN JUAN PR 00902-1190", res)
    ...
    def test_puerto_rico_urbanization(self):
    ...
    def test_diacritics_complex(self):
        address = "Âbčdëf N Gâté Blvd\nSan José, CA 95112"
        # removes diacritics, normalizes
        res = normalize_address(address)
        self.assertIn("ABCDEF N GATE BLVD", res)
        self.assertIn("SAN JOSE CA 95112", res)

    def test_department_of_state(self):
    ...
    def test_hyphenated_address_ranges(self):
    ...
    def test_puerto_rico_exceptions_negative(self):
        ...
        self.assertTrue(res.startswith("PO BOX 1190"))

    def test_private_mailbox(self):
    ...
    def test_appendix_c_highways(self):
        cases = [
            (
                "COUNTY HIGHWAY 140\nHERNDON VA 22071",
                "COUNTY HIGHWAY 140\nHERNDON VA 22071",
    ...
    def test_all_diacritics(self):
        ...
        self.assertIn(expected_str, res)
