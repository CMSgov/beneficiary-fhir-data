...
tables = [
    ...
    {"csv_name": "SYNTHETIC_BENE_LIS.csv", "table": "v2_mdcr_bene_lis"},
    {"csv_name": "SYNTHETIC_BENE_MAPD_ENRLMT.csv", "table": "v2_mdcr_bene_mapd_enrlmt"},
    {"csv_name": "SYNTHETIC_BENE_MAPD_ENRLMT_RX.csv", "table": "v2_mdcr_bene_mapd_enrlmt_rx"},
