...
from idr_pipeline.matching.parser import normalize_address
...
class TestProjectUsatParser(unittest.TestCase):
    ...
    def test_po_box(self) -> None:
        ...
        assert "SAN JUAN PR 00902-1190" not in res
    ...
    def test_diacritics_complex(self) -> None:
        ...
        assert "SAN JOSE CA 95112" not in res

    def test_department_of_state(self) -> None:
        address = "UNIT 9900 BOX 0500\nDPO AE 09701-0500"
        expected = "UNIT 9900 BOX 500"  # box removes leading zeros
        assert normalize_address(address) == expected
    ...
    def test_all_diacritics(self) -> None:
        from idr_pipeline.matching.constants import DIACRITICS
