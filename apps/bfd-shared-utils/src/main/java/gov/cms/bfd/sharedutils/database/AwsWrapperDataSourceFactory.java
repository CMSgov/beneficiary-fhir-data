...
public class AwsWrapperDataSourceFactory implements SimpleDataSourceFactory {
                ...
                (HostSpec hostSpec, Properties originalProps) -> {
                  ...
                  config.setMaximumPoolSize(
                      Math.max(
                          ...
                          databaseOptions.getMaxPoolSize()));

                  // The following lines are copied verbatim from the default configuration of
                  // profile E:
  ...
  public DataSource createDataSource() {
    ...
    targetDataSourceProps.setProperty(
        AuroraInitialConnectionStrategyPlugin.READER_HOST_SELECTOR_STRATEGY.name, "roundRobin");
