...
def create_mapping(summary):
    ...
    # BeneficiaryMonthly is an exception to the rule in the code generated by annotation processor
    if mapping["id"] == "BeneficiaryMonthly":
        table["compositeKeyClassName"] = "BeneficiaryMonthlyId"
