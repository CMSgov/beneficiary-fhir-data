...
CREATE TABLE beneficiaries (
    ...
    bene_link_key                            numeric(38,0),                            -- beneLinkKey
...
CREATE TABLE beneficiary_monthly (
    ...
    part_d_contract_number_id                character varying(5),                     -- partDContractNumberId
    part_c_contract_number_id                character varying(5),                     -- partCContractNumberId
    ...
    part_c_pbp_number_id                     character varying(3),                     -- partCPbpNumberId
    part_c_plan_type_code                    character varying(3),                     -- partCPlanTypeCode   
    part_d_pbp_number_id                     character varying(3),                     -- partDPbpNumberId
    part_d_segment_number_id                 character varying(3),                     -- partDSegmentNumberId
    part_d_retiree_drug_subsidy_ind          character(1),                             -- partDRetireeDrugSubsidyInd
    medicaid_dual_eligibility_code           character varying(2),                     -- medicaidDualEligibilityCode
    part_d_low_income_cost_share_group_code  character varying(2)                      -- partDLowIncomeCostShareGroupCode
);
--
--
...
--
--
CREATE SEQUENCE beneficiaryhistory_beneficiaryhistoryid_seq
...
--
--
CREATE SEQUENCE beneficiaryhistorytemp_beneficiaryhistoryid_seq
START WITH 53275601
INCREMENT BY 50
NO MINVALUE
NO MAXVALUE
...
--
--
CREATE SEQUENCE loaded_batches_loadedbatchid_seq
START WITH 1
INCREMENT BY 20
NO MINVALUE
NO MAXVALUE
...
--
--
CREATE SEQUENCE loaded_files_loadedfileid_seq
START WITH 1
INCREMENT BY 1
NO MINVALUE
NO MAXVALUE
...
--
--
ALTER TABLE ONLY beneficiaries_history_invalid_beneficiaries
ADD CONSTRAINT beneficiaries_history_invalid_beneficiaries_pkey PRIMARY KEY (beneficiaryHistoryId);
--
--
ALTER TABLE ONLY beneficiaries_history
ADD CONSTRAINT beneficiaries_history_pkey PRIMARY KEY (beneficiaryHistoryId);
--
--
...
--
--
ALTER TABLE ONLY beneficiary_monthly_audit
ADD CONSTRAINT beneficiary_monthlyAudit_pkey PRIMARY KEY (parentBeneficiary, yearMonth);
--
--
ALTER TABLE ONLY beneficiary_monthly
ADD CONSTRAINT beneficiary_monthly_pkey PRIMARY KEY (parentBeneficiary, yearMonth);
--
--
ALTER TABLE ONLY carrier_claim_lines
ADD CONSTRAINT carrier_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY carrier_claims
ADD CONSTRAINT carrier_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY dme_claim_lines
ADD CONSTRAINT dme_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY dme_claims
ADD CONSTRAINT dme_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY hha_claim_lines
ADD CONSTRAINT hha_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY hha_claims
ADD CONSTRAINT hha_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY hospice_claim_lines
ADD CONSTRAINT hospice_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY hospice_claims
ADD CONSTRAINT hospice_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY inpatient_claim_lines
ADD CONSTRAINT inpatient_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY inpatient_claims
ADD CONSTRAINT inpatient_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY loaded_batches
ADD CONSTRAINT loaded_batches_pkey PRIMARY KEY (loadedBatchId);
--
--
ALTER TABLE ONLY loaded_files
ADD CONSTRAINT loaded_files_pkey PRIMARY KEY (loadedFileId);
--
--
ALTER TABLE ONLY medicare_beneficiaryid_history_invalid_beneficiaries
ADD CONSTRAINT medicare_beneficiaryid_history_invalid_beneficiaries_pkey PRIMARY KEY (medicareBeneficiaryIdKey);
--
--
ALTER TABLE ONLY medicare_beneficiaryid_history
ADD CONSTRAINT medicare_beneficiaryid_history_pkey PRIMARY KEY (medicareBeneficiaryIdKey);
--
--
ALTER TABLE ONLY outpatient_claim_lines
ADD CONSTRAINT outpatient_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY outpatient_claims
ADD CONSTRAINT outpatient_claims_pkey PRIMARY KEY (claimId);
--
--
ALTER TABLE ONLY partd_events
ADD CONSTRAINT partd_events_pkey PRIMARY KEY (eventId);
--
--
ALTER TABLE ONLY snf_claim_lines
ADD CONSTRAINT snf_claim_lines_pkey PRIMARY KEY (parentClaim, lineNumber);
--
--
ALTER TABLE ONLY snf_claims
ADD CONSTRAINT snf_claims_pkey PRIMARY KEY (claimId);
--
--
CREATE INDEX beneficiaries_history_beneficiaryId_idx ON beneficiaries_history USING btree (beneficiaryId);
--
--
CREATE INDEX beneficiaries_history_hicn_idx ON beneficiaries_history USING btree (hicn);
--
--
CREATE INDEX beneficiaries_hicn_idx ON beneficiaries USING btree (hicn);
--
--
CREATE INDEX Beneficiaries_history_mbi_hash_idx ON beneficiaries_history USING btree (mbiHash);
--
--
CREATE INDEX beneficiaries_mbi_hash_idx ON beneficiaries USING btree (mbiHash);
--
--
CREATE INDEX beneficiaries_partd_contract_number_apr_id_idx ON beneficiaries USING btree (partDContractNumberAprId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_aug_id_idx ON beneficiaries USING btree (partDContractNumberAugId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_dec_id_idx ON beneficiaries USING btree (partDContractNumberDecId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_feb_id_idx ON beneficiaries USING btree (partDContractNumberFebId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_jan_id_idx ON beneficiaries USING btree (partDContractNumberJanId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_jul_id_idx ON beneficiaries USING btree (partDContractNumberJulId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_jun_id_idx ON beneficiaries USING btree (partDContractNumberJunId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_mar_id_idx ON beneficiaries USING btree (partDContractNumberMarId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_may_id_idx ON beneficiaries USING btree (partDContractNumberMayId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_nov_id_idx ON beneficiaries USING btree (partDContractNumberNovId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_oct_id_idx ON beneficiaries USING btree (partDContractNumberOctId);
--
--
CREATE INDEX beneficiaries_partd_contract_number_sept_id_idx ON beneficiaries USING btree (partDContractNumberSeptId);
--
--
CREATE INDEX beneficiary_monthly_partDContractNumberId_yearmonth_idx ON beneficiary_monthly USING btree (partDContractNumberId, yearMonth);
--
--
CREATE INDEX carrier_claims_beneficiaryId_idx ON carrier_claims USING btree (beneficiaryId);
--
--
CREATE INDEX dme_claims_beneficiaryId_idx ON dme_claims USING btree (beneficiaryId);
--
--
CREATE INDEX hha_claims_beneficiaryId_idx ON hha_claims USING btree (beneficiaryId);
--
--
CREATE INDEX hospice_claims_beneficiaryId_idx ON hospice_claims USING btree (beneficiaryId);
--
--
CREATE INDEX inpatient_claims_beneficiaryId_idx ON inpatient_claims USING btree (beneficiaryId);
--
--
CREATE INDEX loaded_batches_created_index ON loaded_batches USING btree (created);
--
--
CREATE INDEX medicare_beneficiaryid_history_beneficiaryId_idx ON medicare_beneficiaryid_history USING btree (beneficiaryId);
--
--
CREATE INDEX outpatient_claims_beneficiaryId_idx ON outpatient_claims USING btree (beneficiaryId);
--
--
CREATE INDEX partd_events_beneficiaryId_idx ON partd_events USING btree (beneficiaryId);
--
--
CREATE INDEX snf_claims_beneficiaryId_idx ON snf_claims USING btree (beneficiaryId);
--
--
ALTER TABLE ONLY beneficiaries_history
ADD CONSTRAINT beneficiaries_history_beneficiaryId_to_Beneficiary FOREIGN KEY (beneficiaryId) REFERENCES Beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY beneficiary_monthly
ADD CONSTRAINT beneficiary_monthly_parentBeneficiary_to_Beneficiary FOREIGN KEY (parentBeneficiary) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY carrier_claim_lines
ADD CONSTRAINT carrier_claim_lines_parentClaim_to_carrier_claims FOREIGN KEY (parentClaim) REFERENCES carrier_claims(claimId);
--
--
ALTER TABLE ONLY carrier_claims
ADD CONSTRAINT carrier_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY dme_claim_lines
ADD CONSTRAINT dme_claim_lines_parentClaim_to_dme_claims FOREIGN KEY (parentClaim) REFERENCES dme_claims(claimId);
--
--
ALTER TABLE ONLY dme_claims
ADD CONSTRAINT dme_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY hha_claim_lines
ADD CONSTRAINT hha_claim_lines_parentClaim_to_hha_claims FOREIGN KEY (parentClaim) REFERENCES hha_claims(claimId);
--
--
ALTER TABLE ONLY hha_claims
ADD CONSTRAINT hha_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY hospice_claim_lines
ADD CONSTRAINT hospice_claim_lines_parentClaim_to_hospice_claims FOREIGN KEY (parentClaim) REFERENCES hospice_claims(claimId);
--
--
ALTER TABLE ONLY hospice_claims
ADD CONSTRAINT hospice_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY inpatient_claim_lines
ADD CONSTRAINT inpatient_claim_lines_parentClaim_to_inpatient_claims FOREIGN KEY (parentClaim) REFERENCES inpatient_claims(claimId);
--
--
ALTER TABLE ONLY inpatient_claims
ADD CONSTRAINT inpatient_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY medicare_beneficiaryid_history
ADD CONSTRAINT medicare_beneficiaryid_history_beneficiaryId_to_Beneficiary FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY outpatient_claim_lines
ADD CONSTRAINT outpatient_claim_lines_parentClaim_to_outpatient_claims FOREIGN KEY (parentClaim) REFERENCES outpatient_claims(claimId);
--
--
ALTER TABLE ONLY outpatient_claims
ADD CONSTRAINT outpatient_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY partd_events
ADD CONSTRAINT partd_events_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY snf_claim_lines
ADD CONSTRAINT snf_claim_lines_parentClaim_to_snf_claims FOREIGN KEY (parentClaim) REFERENCES snf_claims(claimId);
--
--
ALTER TABLE ONLY snf_claims
ADD CONSTRAINT snf_claims_beneficiaryId_to_beneficiaries FOREIGN KEY (beneficiaryId) REFERENCES beneficiaries(beneficiaryId);
--
--
ALTER TABLE ONLY loaded_batches
ADD CONSTRAINT loaded_batches_loadedFileId FOREIGN KEY (loadedFileId) REFERENCES loaded_files(loadedFileId);
