...
${logic.hsql-only}	create table public.snf_claims_new (
	...
	${logic.hsql-only}	clm_pps_cptl_dsprprtnt_shr_amt		numeric(10,2),
	${logic.hsql-only}	clm_pps_cptl_excptn_amt				numeric(10,2),
	${logic.hsql-only}	clm_pps_cptl_fsp_amt				numeric(10,2),
	${logic.hsql-only}	clm_pps_cptl_ime_amt				numeric(10,2),
	${logic.hsql-only}	clm_pps_cptl_outlier_amt			numeric(10,2),
	${logic.hsql-only}	clm_pps_old_cptl_hld_hrmls_amt		numeric(10,2),
	...
	${logic.hsql-only}	nch_bene_ip_ddctbl_amt				numeric(10,2) NOT NULL,
	${logic.hsql-only}	nch_bene_pta_coinsrnc_lblty_am		numeric(10,2) NOT NULL,
	${logic.hsql-only}	nch_ip_ncvrd_chrg_amt				numeric(10,2) NOT NULL,
	${logic.hsql-only}	nch_ip_tot_ddctn_amt				numeric(10,2) NOT NULL,
...
select
	...
	clm_pps_ind_cd,
	${logic.hsql-only} clm_pps_cptl_dsprprtnt_shr_amt,
	${logic.psql-only} cast(clm_pps_cptl_dsprprtnt_shr_amt as numeric(10,2)),
	${logic.hsql-only} clm_pps_cptl_excptn_amt,
	${logic.psql-only} cast(clm_pps_cptl_excptn_amt as numeric(10,2)),
	${logic.hsql-only} clm_pps_cptl_fsp_amt,
	${logic.psql-only} cast(clm_pps_cptl_fsp_amt as numeric(10,2)),		
	${logic.hsql-only} clm_pps_cptl_ime_amt,
	${logic.psql-only} cast(clm_pps_cptl_ime_amt as numeric(10,2)),	
	${logic.hsql-only} clm_pps_cptl_outlier_amt,
	${logic.psql-only} cast(clm_pps_cptl_outlier_amt as numeric(10,2)),	
	${logic.hsql-only} clm_pps_old_cptl_hld_hrmls_amt,
	${logic.psql-only} cast(clm_pps_old_cptl_hld_hrmls_amt as numeric(10,2)),	
	nch_clm_type_cd,
	...
	${logic.hsql-only} nch_bene_ip_ddctbl_amt,
	${logic.psql-only} cast(nch_bene_ip_ddctbl_amt as numeric(10,2)),
	${logic.hsql-only} nch_bene_pta_coinsrnc_lblty_am,
	${logic.psql-only} cast(nch_bene_pta_coinsrnc_lblty_am as numeric(10,2)),
	${logic.hsql-only} nch_ip_ncvrd_chrg_amt,
	${logic.psql-only} cast(nch_ip_ncvrd_chrg_amt as numeric(10,2)),
	${logic.hsql-only} nch_ip_tot_ddctn_amt,
	${logic.psql-only} cast(nch_ip_tot_ddctn_amt as numeric(10,2)),
