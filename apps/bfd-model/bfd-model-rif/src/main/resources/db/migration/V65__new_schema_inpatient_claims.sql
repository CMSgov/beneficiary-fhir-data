-- NEW_SCHEMA_INPATIENT_CLAIMS.SQL
-- flyway migration for INPATIENT_CLAIMS and INPATIENT_CLAIM_LINES tables into
...
--   3) organizes parent claim table (INPATIENT_CLAIMS) such that common
...
${logic.hsql-only}    clm_pass_thru_per_diem_amt               numeric(12,2) not null,                   
...
${logic.hsql-only}    clm_drg_outlier_stay_cd                  char(1) not null,                    
...
${logic.hsql-only}    clm_pps_cptl_drg_wt_num                  numeric(7,4),                             
...
${logic.hsql-only}    clm_uncompd_care_pmt_amt                 numeric(12,2),                            
${logic.hsql-only}    clm_tot_pps_cptl_amt                     numeric(12,2),                            
${logic.hsql-only}    clm_src_ip_admsn_cd                      char(1),                             
${logic.hsql-only}    bene_lrd_used_cnt                        smallint,                                 
...
${logic.hsql-only}    nch_blood_pnts_frnshd_qty                smallint not null,                        
...
${logic.hsql-only}    nch_drg_outlier_aprvd_pmt_amt            numeric(12,2),                            
...
${logic.hsql-only}    dsh_op_clm_val_amt                       numeric(12,2),                            
${logic.hsql-only}    ime_op_clm_val_amt                       numeric(12,2),                            
...
${logic.hsql-only}    clm_poa_ind_sw2                          char(1),
...
${logic.hsql-only}    clm_e_poa_ind_sw7                        char(1),
...
${logic.hsql-only}    clm_poa_ind_sw9                          char(1),
...
${logic.hsql-only}    clm_poa_ind_sw10                         char(1),
...
${logic.hsql-only}    clm_poa_ind_sw13                         char(1),
...
${logic.hsql-only}    clm_poa_ind_sw19                         char(1),
...
${logic.hsql-only} constraint public.inpatient_claims_new_pkey
${logic.hsql-only} primary key (clm_id) );

-- create a new INPATIENT_CLAIM_LINES_NEW table in the current PUBLIC schema
--
${logic.hsql-only} CREATE TABLE IF NOT EXISTS public.inpatient_claim_lines_new (
${logic.hsql-only}    clm_id                                   bigint NOT NULL,
...
${logic.hsql-only}  CONSTRAINT inpatient_claim_lines_new_pkey
...
--
${logic.hsql-only} insert into public.inpatient_claims_new (
...
${logic.hsql-only}    clm_pass_thru_per_diem_amt,
...
${logic.hsql-only}    clm_uncompd_care_pmt_amt,
${logic.hsql-only}    clm_tot_pps_cptl_amt,
${logic.hsql-only}    clm_src_ip_admsn_cd,
${logic.hsql-only}    bene_lrd_used_cnt,
...
${logic.hsql-only}    nch_drg_outlier_aprvd_pmt_amt,
...
${logic.hsql-only}    dsh_op_clm_val_amt,
${logic.hsql-only}    ime_op_clm_val_amt,
...
${logic.hsql-only}    clm_poa_ind_sw1,
${logic.hsql-only}    clm_e_poa_ind_sw1,
...
${logic.hsql-only}    clm_e_poa_ind_sw2,
...
${logic.hsql-only}    clm_poa_ind_sw3,
${logic.hsql-only}    clm_e_poa_ind_sw3,
...
${logic.hsql-only}    clm_poa_ind_sw4,
${logic.hsql-only}    clm_e_poa_ind_sw4,
...
${logic.hsql-only}    clm_poa_ind_sw5,
${logic.hsql-only}    clm_e_poa_ind_sw5,
...
${logic.hsql-only}    clm_poa_ind_sw6,
${logic.hsql-only}    clm_e_poa_ind_sw6,
...
${logic.hsql-only}    clm_poa_ind_sw7,
...
${logic.hsql-only}    clm_poa_ind_sw8,
${logic.hsql-only}    clm_e_poa_ind_sw8,
...
${logic.hsql-only}    clm_e_poa_ind_sw9,
...
${logic.hsql-only}    clm_e_poa_ind_sw10,
...
${logic.hsql-only}    clm_poa_ind_sw11,
${logic.hsql-only}    clm_e_poa_ind_sw11,
...
${logic.hsql-only}    clm_poa_ind_sw12,
${logic.hsql-only}    clm_e_poa_ind_sw12,
...
${logic.hsql-only}    clm_poa_ind_sw13,
...
${logic.hsql-only}    clm_poa_ind_sw14,
...
${logic.hsql-only}    clm_poa_ind_sw15,
...
${logic.hsql-only}    clm_poa_ind_sw16,
...
${logic.hsql-only}    clm_poa_ind_sw17,
...
${logic.hsql-only}    clm_poa_ind_sw18,
...
${logic.hsql-only}    clm_poa_ind_sw20,
...
${logic.hsql-only}    clm_poa_ind_sw21,
...
${logic.hsql-only}    clm_poa_ind_sw22,
...
${logic.hsql-only}    clm_poa_ind_sw23,
...
${logic.hsql-only}    clm_poa_ind_sw24,
...
${logic.hsql-only}    clm_poa_ind_sw25 )
--
...
${logic.psql-only} create table public.inpatient_claims_new as
select
...
${logic.hsql-only}  convert(clm_non_utlztn_days_cnt, SQL_SMALLINT),
${logic.psql-only}  cast(clm_utlztn_day_cnt as smallint),
${logic.hsql-only}  convert(clm_utlztn_day_cnt, SQL_SMALLINT),
                    ...
                    clm_src_ip_admsn_cd,
${logic.psql-only}  cast(bene_lrd_used_cnt as smallint),
${logic.hsql-only}  convert(bene_lrd_used_cnt, SQL_SMALLINT),
                    prncpal_dgns_cd,
...
${logic.hsql-only}  convert(bene_tot_coinsrnc_days_cnt, SQL_SMALLINT),
                    admtg_dgns_cd,
                    admtg_dgns_vrsn_cd,
                    at_physn_npi,
                    at_physn_upin,
                    ...
                    nch_bene_dschrg_dt,
${logic.psql-only}  cast(nch_blood_pnts_frnshd_qty as smallint),
${logic.hsql-only}  convert(nch_blood_pnts_frnshd_qty, SQL_SMALLINT),
...
--
${logic.psql-only} alter table public.inpatient_claims_new
...
${logic.psql-only}    alter column clm_pass_thru_per_diem_amt     SET NOT NULL,   
...
${logic.psql-only}    alter column clm_drg_outlier_stay_cd        SET NOT NULL,   
...
--
${logic.hsql-only} insert into public.inpatient_claim_lines_new (
${logic.hsql-only}    clm_id,
...
-- associated SELECT statement used to populate the table.
--
${logic.psql-only} create table public.inpatient_claim_lines_new as
select
${logic.psql-only}    cast(clm_id as bigint),
${logic.hsql-only}    convert(clm_id, SQL_BIGINT),
...
-- we explicitly defined a table structure before migrating data.
--
${logic.psql-only} alter table public.inpatient_claim_lines_new
${logic.psql-only}    alter column clm_id                         SET NOT NULL,
...
${logic.psql-only} alter table public.inpatient_claims_new
${logic.psql-only}     add CONSTRAINT inpatient_claims_new_pkey PRIMARY KEY (clm_id);

-- for PSQL need to define our primary key    
${logic.psql-only} ALTER TABLE public.inpatient_claim_lines_new
${logic.psql-only}     ADD CONSTRAINT inpatient_claim_lines_new_pkey PRIMARY KEY (clm_id, clm_line_num);

-- define foreign key constraints between claim lineitems and a parent claims table.
ALTER TABLE IF EXISTS public.inpatient_claim_lines_new
    ADD CONSTRAINT inpatient_claim_lines_clm_id_to_inpatient_claims_new FOREIGN KEY (clm_id)
        REFERENCES public.inpatient_claims_new (clm_id);

-- create an index of the BENE_ID in parent claims table
CREATE INDEX IF NOT EXISTS inpatient_claims_new_bene_id_idx
    ON public.inpatient_claims_new (bene_id);
