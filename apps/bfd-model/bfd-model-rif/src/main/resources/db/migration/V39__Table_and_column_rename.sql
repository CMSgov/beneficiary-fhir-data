...
--${logic.hsql-only-alter} table public."LoadedBatches" drop constraint "LoadedBatches_pkey";
--${logic.hsql-only-alter} table public."LoadedFiles" drop constraint "LoadedFiles_pkey";
--
