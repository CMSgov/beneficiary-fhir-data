/*
  This callback adds a set of functions to help manage schema ownserhip and role based access controls. It is
  executed before Flyway creates any non-existing schemas.
