/*
  Adds a set of functions to help make managing role-based access controls and object ownship easier:
    ...
    - add_reader_role_to_schema(role_name TEXT, schema_name TEXT)
    - add_writer_role_to_schema(role_name TEXT, schema_name TEXT)
    - add_migrator_role_to_schema(role_name TEXT, schema_name TEXT)
    - add_db_group_if_not_exists(db_name TEXT, group_name TEXT)
    - set_fhirdb_owner(role_name TEXT)
...
${logic.psql-only}       -- like pg_stat_statements, just log the error and continue
