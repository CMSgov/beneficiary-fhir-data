...
for i in range(patients_to_generate):
    ...
    if(random.randint(0,10)<2):
        #death!
        death_date = generator.fake.date_between_dates(datetime.date(year=2020, month=1, day=1),datetime.date.today())
    ...
    for idx in range(0,random.randint(0,2)):
        ...
        generator.used_bene_sk.append(pt_bene_sk)
        prior_patient['IDR_TRANS_OBSLT_TS'] = '2021-01-02 00:00:00.000000'
        prior_patient['IDR_UPDT_TS'] = str(datetime.datetime.now()-datetime.timedelta(days=1))
