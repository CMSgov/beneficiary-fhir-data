...
/** Implementation of {@link FieldTransformer} for use with date fields. */
public class DateFieldTransformer implements FieldTransformer {
  /**
   * {@inheritDoc}
   *
   * <p>Generate code to call either {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyDate} or {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyOptionalDate} depending on whether the
   * field is optional.
   *
