...
/**
 * Implementation of {@link FieldTransformer} for use with long fields that are stored as strings in
 * the source but native longs in the destination.
 */
public class LongStringFieldTransformer implements FieldTransformer {
  /**
   * {@inheritDoc}
   *
   * <p>Generate code to call either {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyLongString} or {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyOptionalLongString} depending on whether
