...
/** Implementation of {@link FieldTransformer} for use with single character fields. */
public class CharFieldTransformer implements FieldTransformer {
  /**
   * {@inheritDoc}
   *
   * <p>Generate code to call either {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyCharacter} or {@link
   * gov.cms.model.dsl.codegen.library.DataTransformer#copyOptionalCharacter} depending on whether
