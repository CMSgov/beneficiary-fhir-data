...
public interface FieldTransformer {
   ...
   * example, the generated code can use {@link SOURCE_VAR} to reference the RDA API source object,
   * {@link DEST_VAR} to reference the destination entity object, and {@link TRANSFORMER_VAR} to
