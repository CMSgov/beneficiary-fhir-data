...
/** Integration test for the {@link GenerateEntitiesFromDslMojo}. */
public class GenerateEntitiesFromDslMojoIT extends AbstractMojoIntegrationTestCase {
  /**
  ...
  private static final List<String> OUTPUT_FILE_PATHS =
      List.of(
          "gov/cms/test/FissClaim.java",
          "gov/cms/test/FissPayer.java",
          "gov/cms/test/FissProcCode.java",
          "gov/cms/test/NoTransforms.java",
          "gov/cms/test/StandAloneEnum.java");
  ...
  public void testPlugin(@TempDir File outputDirectory) throws Exception {
    ...
    final var mojo =
        new GenerateEntitiesFromDslMojo(mappingsDirectoryPath, outputDirectoryPath, project);
    mojo.execute();
