...
public class FissClaimTransformerV2 extends AbstractTransformerV2 {
  ...
  private static Period getBillablePeriod(RdaFissClaim claimGroup) {
    return new Period()
        .setStart(localDateToDate(claimGroup.getStmtCovFromDate()), TemporalPrecisionEnum.DAY)
        .setEnd(localDateToDate(claimGroup.getStmtCovToDate()), TemporalPrecisionEnum.DAY);
  }
