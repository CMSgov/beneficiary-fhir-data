...
import gov.cms.bfd.server.war.r4.providers.BeneficiaryTransformer.CurrencyIdentifier;
import gov.cms.bfd.server.war.r4.providers.Diagnosis.DiagnosisLabel;
...
public final class TransformerUtils {
  ...
  static void addDiagnosisLink(ExplanationOfBenefit eob, ItemComponent item, Diagnosis diagnosis) {
    ...
    item.addDiagnosisSequence(diagnosisSequence);
  }
  ...
  static void mapEobCommonGroupCarrierDME(
    ...
    if (referringPhysicianNpi.isPresent()) {
      ...
      referral.setStatus(ServiceRequestStatus.COMPLETED);
      ...
      referral.setRequester(referencePractitioner(referringPhysicianNpi.get()));
  ...
  static void mapEobCommonGroupInpOutHHAHospiceSNF(
    ...
    eob.addTotal()
        ...
        .setCategory(
            new CodeableConcept()
                .addCoding(
                    new Coding().setCode("http://terminology.hl7.org/CodeSystem/adjudication")));
  ...
  /**
   * HL7 Race Code system (R4/CARIN) US-Core Race
   *
   * @return raceTable
   */
  public static final Hashtable<String, String> getOMBRaceTable() {

    Hashtable<String, String> raceTable = new Hashtable<String, String>();

    raceTable.put("0", TransformerConstants.CCW_RACE_0_OMB);
    raceTable.put("1", TransformerConstants.CCW_RACE_1_OMB);
    raceTable.put("2", TransformerConstants.CCW_RACE_2_OMB);
    raceTable.put("3", TransformerConstants.CCW_RACE_3_OMB);
    raceTable.put("4", TransformerConstants.CCW_RACE_4_OMB);
    raceTable.put("5", TransformerConstants.CCW_RACE_5_OMB);
    raceTable.put("6", TransformerConstants.CCW_RACE_6_OMB);
   ...
   * HL7 Race Code system (R4/CARIN) US-Core Race
   *
   * @return raceOMBDisplay
   */
  public static final Hashtable<String, String> getOMBRaceDisplay() {

    Hashtable<String, String> raceOMBDisplay = new Hashtable<String, String>();

    raceOMBDisplay.put("0", TransformerConstants.CCW_RACE_0_OMB_DISPLAY);
    raceOMBDisplay.put("1", TransformerConstants.CCW_RACE_1_OMB_DISPLAY);
    raceOMBDisplay.put("2", TransformerConstants.CCW_RACE_2_OMB_DISPLAY);
    raceOMBDisplay.put("3", TransformerConstants.CCW_RACE_3_OMB_DISPLAY);
    raceOMBDisplay.put("4", TransformerConstants.CCW_RACE_4_OMB_DISPLAY);
    raceOMBDisplay.put("5", TransformerConstants.CCW_RACE_5_OMB_DISPLAY);
    raceOMBDisplay.put("6", TransformerConstants.CCW_RACE_6_OMB_DISPLAY);
