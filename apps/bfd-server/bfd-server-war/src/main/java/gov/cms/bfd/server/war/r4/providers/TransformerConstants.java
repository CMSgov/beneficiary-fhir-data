...
public final class TransformerConstants {
   ...
   * supported by {@link R4PatientResourceProvider} for backwards compatibility reasons.
   */
  ...
  /**
   * The US-Core OM Race code <a
   * href="https://www.hl7.org/fhir/us/core/StructureDefinition-us-core-race.html">US Core Race</a>
   * .
   */
  static final String CODING_RACE_US =
      "http://hl7.org/fhir/us/core/StructureDefinition/us-core-race";

  /**
   * Display value for Patient Internal Identifier <a
   * href="https://www.hl7.org/fhir/v2/0203/index.html">identifier-type</a>
   */
  static final String PATIENT_PI_ID_DISPLAY = "Patient Internal Identifier";

  /**
   * Display value for Patient MRN <a
   * href="https://www.hl7.org/fhir/v2/0203/index.html">identifier-type</a>
   */
  static final String PATIENT_MRN_ID_DISPLAY = "Medical record number";

  /**
   * Display value for Patient Medicare Id <a
   * href="https://www.hl7.org/fhir/v2/0203/index.html">identifier-type</a>
   */
  static final String PATIENT_MC_ID_DISPLAY = "Patient's Medicare Number";
  ...
  static final String HL7_RACE_UNKNOWN_CODE = "UNK";
  static final String HL7_RACE_UNKNOWN_DISPLAY = "Unknown";

  static final String CCW_RACE_0_OMB = "UNK";
  static final String CCW_RACE_1_OMB = "2106-3";
  static final String CCW_RACE_2_OMB = "2054-5";
  static final String CCW_RACE_3_OMB = "ASKU";
  static final String CCW_RACE_4_OMB = "2028-9";
  static final String CCW_RACE_5_OMB = "UNK";
  static final String CCW_RACE_6_OMB = "1002-5";

  static final String CCW_RACE_0_OMB_DISPLAY = "Unknown";
  static final String CCW_RACE_1_OMB_DISPLAY = "White";
  static final String CCW_RACE_2_OMB_DISPLAY = "Black or African American";
  static final String CCW_RACE_3_OMB_DISPLAY = "Asked but no answer";
  static final String CCW_RACE_4_OMB_DISPLAY = "Asian";
  static final String CCW_RACE_5_OMB_DISPLAY = "Unknown";
  static final String CCW_RACE_6_OMB_DISPLAY = "American Indian or Alaska Native";
}
