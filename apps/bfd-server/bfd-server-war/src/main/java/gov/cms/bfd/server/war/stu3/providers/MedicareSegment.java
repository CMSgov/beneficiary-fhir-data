...
public enum MedicareSegment {
	 ...
	 * 
	 * @param urlPrefix
	 *            the value to use for {@link #getUrlPrefix()}
	 */
	...
	/**
	 * @return a {@link String} that can be used in URLs to uniquely identify
	 *         this {@link MedicareSegment} (e.g. as part of FHIR
	 *         {@link Coverage#getId()} values)
	 */
	...
	/**
	 * @param urlPrefix
	 *            the {@link #getUrlPrefix()} to find a match for
	 * @return the {@link MedicareSegment} (if any) whose
	 *         {@link MedicareSegment#getUrlPrefix()} value matches the one
	 *         specified
	 */
