 ...
 *
 * <p>
 * If deployed in a Servlet 3.0 container, this application will be found and loaded automagically,
 * as this project includes Spring's {@link SpringServletContainerInitializer} in its dependencies.
 * That class is a registered {@link ServletContainerInitializer} SPI and will in turn search for
 * and enable any {@link WebApplicationInitializer} implementations (such as this class).
 */
public final class ServerInitializer implements WebApplicationInitializer {
  ...
  public void onStartup(ServletContext servletContext) throws ServletException {
    ...
    servletContext.setAttribute(InstrumentedFilter.REGISTRY_ATTRIBUTE,
        springContext.getBean(MetricRegistry.class));
