...
public class GenerateSamhsaComparatorFilesTest {
  ...
  private int createSamhsaSampleFile(
    ...
    switch (claimType) {
      case CARRIER:
        ...
        // Uses ICD_DGNS_CD
        String sampleCarrierIcd9Line = setSubColumns(sampleCarrierLine, header, "ICD_DGNS_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleCarrierIcd9Line);

        // Uses ICD_DGNS_CD
        String sampleCarrierIcd10Line = setSubColumns(sampleCarrierLine, header, "ICD_DGNS_CD1", false, true);
      ...
      case DME:
        ...
        // Uses ICD_DGNS_CD
        String sampleDmeIcd9Line = setSubColumns(sampleDmeLine, header, "ICD_DGNS_CD1", true, false);
        ...
        String sampleDmeIcd10Line = setSubColumns(sampleDmeLine, header, "ICD_DGNS_CD1", false, true);
      ...
      case HHA:
        ...
        // Uses ICD_DGNS_CD
        String sampleHhaIcd9Line = setSubColumns(sampleHhaLine, header, "ICD_DGNS_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleHhaIcd9Line);

        // Uses ICD_DGNS_CD
        // ICD Version determines if they are 9 or 10 (10 is 0, since its a 1 char field), so that
        // is adjusted for these ICD10 codes
        String sampleHhaIcd10Line = setSubColumns(sampleHhaLine, header, "ICD_DGNS_CD1", false, true);
      ...
      case HOSPICE:
        ...
        // Uses ICD_DGNS_CD
        String sampleHospiceIcd9Line = setSubColumns(sampleHospiceLine, header, "ICD_DGNS_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleHospiceIcd9Line);

        // Uses ICD_DGNS_CD
        String sampleHospiceIcd10Line = setSubColumns(sampleHospiceLine, header, "ICD_DGNS_CD1", false, true);
      ...
      case INPATIENT:
        ...
        // Uses ICD_DGNS_CD
        String sampleInpatientIcd9Line = setSubColumns(sampleInpatientLine, header, "ICD_DGNS_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleInpatientIcd9Line);

        // Uses ICD_DGNS_CD
        String sampleInpatientIcd10Line = setSubColumns(sampleInpatientLine, header, "ICD_DGNS_CD1", false, true);
        ...
        String sampleInpatientProc9Line = setSubColumns(sampleInpatientLine, header, "ICD_PRCDR_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9ProcedureCodes, sampleInpatientProc9Line);
        String sampleInpatientProc10Line = setSubColumns(sampleInpatientLine, header, "ICD_PRCDR_CD1", false, true);
      ...
      case OUTPATIENT:
        ...
        // Uses ICD_DGNS_CD
        String sampleOutpatientIcd9Line = setSubColumns(sampleOutpatientLine, header, "ICD_DGNS_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleOutpatientIcd9Line);

        // Uses ICD_DGNS_CD
        String sampleOutpatientIcd10Line = setSubColumns(sampleOutpatientLine, header, "ICD_DGNS_CD1", false, true);
        ...
        // Inpatient/outpatient/snf also check for ICD 9/10 procedure codes
        String sampleOutpatientProc9Line = setSubColumns(sampleOutpatientLine, header, "ICD_PRCDR_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9ProcedureCodes, sampleOutpatientProc9Line);
        String sampleOutpatientProc10Line = setSubColumns(sampleOutpatientLine, header, "ICD_PRCDR_CD1", false, true);
      ...
      case SNF:
        ...
        // Uses ICD_DGNS_CD
        String sampleSnfIcd9Line = setSubColumns(sampleSnfLine, header, "ICD_DGNS_CD1", true, false);;
        newClaimId = addLines(lines, newClaimId, icd9DiagnosisCodes, sampleSnfIcd9Line);

        // Uses ICD_DGNS_CD
        String sampleSnfIcd10Line = setSubColumns(sampleSnfLine, header, "ICD_DGNS_CD1", false, true);
        ...
        // Inpatient/outpatient/snf also check for ICD 9/10 procedure codes
        String sampleSnfProc9Line = setSubColumns(sampleSnfLine, header, "ICD_PRCDR_CD1", true, false);
        newClaimId = addLines(lines, newClaimId, icd9ProcedureCodes, sampleSnfProc9Line);
        String sampleSnfProc10Line = setSubColumns(sampleSnfLine, header, "ICD_PRCDR_CD1", false, true);
   ...
   * @param header the header to find the column name's index
   * @param colString the column name to replace in the sample string
   * @param isIcd9 if the value is an ICD9 value, so we set the following column with the appropriate value
   * @param isIcd10 if the value is an ICD10 value, so we set the following column with the appropriate value
   * @return the adjusted line
   */
  private String setSubColumns(String sampleLine, String header, String colString, boolean isIcd9, boolean isIcd10) {
