  ...
  public void shouldHaveDiagnosesMembers() {
    ...
    DiagnosisComponent cmp2 =
        TransformerTestUtilsV2.createDiagnosis(
            ...
            diag2.getSequence(),
            Arrays.asList(
                new Coding("http://hl7.org/fhir/sid/icd-10-cm", "A37", null),
                new Coding("http://hl7.org/fhir/sid/icd-10", "A37", null)),
            new Coding(
    ...
    DiagnosisComponent cmp3 =
        TransformerTestUtilsV2.createDiagnosis(
            ...
            diag3.getSequence(),
            Arrays.asList(
                new Coding("http://hl7.org/fhir/sid/icd-10-cm", "A25", null),
                new Coding("http://hl7.org/fhir/sid/icd-10", "A25", null)),
            new Coding(
                "http://hl7.org/fhir/us/carin-bb/CodeSystem/C4BBClaimDiagnosisType",
                "secondary",
                "Secondary"),
