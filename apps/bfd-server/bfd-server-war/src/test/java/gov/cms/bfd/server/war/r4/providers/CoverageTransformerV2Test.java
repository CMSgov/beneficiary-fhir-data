...
public final class CoverageTransformerV2Test {
  ...
  /**
   * Verifies that the specified {@link gov.cms.bfd.server.war.r4.providers.MedicareSegment#PART_A}
   * {@link Coverage} "looks like" it should, if it were produced from the specified {@link
   * Beneficiary}.
   *
   * <p>NOTE: The following tests are used by the R4CoverageResourceProviderIT integration tests.
   *
