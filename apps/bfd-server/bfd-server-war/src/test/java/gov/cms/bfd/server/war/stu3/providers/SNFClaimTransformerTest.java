...
import gov.cms.bfd.server.war.stu3.providers.CCWProcedure;
import gov.cms.bfd.server.war.stu3.providers.ClaimType;
import gov.cms.bfd.server.war.stu3.providers.MedicareSegment;
import gov.cms.bfd.server.war.stu3.providers.SNFClaimTransformer;
...
public final class SNFClaimTransformerTest {
	...
	static void assertMatches(SNFClaim claim, ExplanationOfBenefit eob) throws FHIRException {
		...
		TransformerTestUtils.assertEobCommonClaimHeaderData(eob, claim.getClaimId(), claim.getBeneficiaryId(),
				ClaimType.SNF, claim.getClaimGroupId().toPlainString(), MedicareSegment.PART_A,
