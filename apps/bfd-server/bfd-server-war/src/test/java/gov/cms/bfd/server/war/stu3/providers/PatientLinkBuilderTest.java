...
public class PatientLinkBuilderTest {
  public static String BASE_CONTRACT_URL =
  ...
  public void noCountTest() {
    PatientLinkBuilder paging = new PatientLinkBuilder(BASE_CONTRACT_URL);
  ...
  public void emptyPageTest() {
    PatientLinkBuilder paging = new PatientLinkBuilder(BASE_CONTRACT_URL + "&_count=10");
  ...
  public void fullPageTest() {
    ...
    PatientLinkBuilder paging = new PatientLinkBuilder(BASE_CONTRACT_URL + "&_count=1");
