...
public final class BfdMDCIT {
  ...
  public void convertsPeriodsToUnderscore() {
    assertEquals("key_that_needs_formatting", BfdMDC.formatMDCKey("key.that.needs.formatting"));
  }
  ...
  public void putsToMDC() {
    BfdMDC.put("key_that_does_not_need_formatting", "This key should be inserted as-is.");
  ...
  /**
   * Test whether {@link BfdMDC#put(String, String)} calls the underlying {@link
   * org.slf4j.MDC#put(String, String)} method, after first replacing "." characters with "_".
   */
  @Test
  public void putsToMDCAndFormats() {
    BfdMDC.put("dot.separated.key", "This key needs to be reformatted to change . into _");
    Mockito.verify(mdcMock)
  ...
  /**
   * Test whether {@link BfdMDC#clear()} calls the underlying {@link org.slf4j.MDC#clear()}
   * function.
   */
  @Test
