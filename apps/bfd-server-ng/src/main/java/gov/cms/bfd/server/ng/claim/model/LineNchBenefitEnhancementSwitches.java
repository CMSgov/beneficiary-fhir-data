...
/** Embeddable component for claim line level NCH benefit enhancement switches. */
@Embeddable
@Getter
public class LineNchBenefitEnhancementSwitches {

  @Column(name = "clm_line_ngaco_pbpmt_sw")
  private Optional<String> pbpBenefitEnhancementIndicator;

  @Column(name = "clm_line_ngaco_pdschrg_hcbs_sw")
  private Optional<String> postDischargeHomeVisitBenefitEnhancementIndicator;

  @Column(name = "clm_line_ngaco_snf_wvr_sw")
  private Optional<String> snf3DayWaiverEnhancement;

  @Column(name = "clm_line_ngaco_tlhlth_sw")
  private Optional<String> telehealthBenefitEnhancementIndicator;

  @Column(name = "clm_line_ngaco_cptatn_sw")
  private Optional<String> aipbpBenefitEnhancementIndicator;

  @Column(name = "clm_line_aco_care_mgmt_hcbs_sw")
