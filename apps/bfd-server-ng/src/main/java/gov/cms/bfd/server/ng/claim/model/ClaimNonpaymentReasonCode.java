...
public sealed interface ClaimNonpaymentReasonCode
   ...
   * @return claim nonpayment reason code or empty Optional if code is null or blank
   */
  static Optional<ClaimNonpaymentReasonCode> tryFromCode(String code) {
    ...
    return Optional.of(
        Arrays.stream(Valid.values())
            ...
            .map(v -> (ClaimNonpaymentReasonCode) v)
            .findFirst()
  ...
  enum Valid implements ClaimNonpaymentReasonCode {
    ...
    /**
     * % - MSP COST AVOIDED - RECOVERY AUDIT CONTRACTOR - CALIFORNIA (25 2-BYTE CODE) (EFF.
     * 10/2005).
     */
    PERCENT(
        "%",
    ...
    /**
     * &amp; - MSP COST AVOIDED - RECOVERY AUDIT CONTRACTOR - FLORIDA (26 2-BYTE CODE) (EFF.
     * 10/2005).
     */
    AMPERSAND(
        "&",
    ...
    /**
     * Z - ZERO REIMBURSEMENT REQUEST FOR ANTICIPATED PAYMENTS (RAPS) - ZERO REIMBURSEMENT MADE DUE
     * TO MEDICAL REVIEW INTERVENTION OR WHERE PROVIDER SPECIFIC ZERO PAYMENT HAS BEEN DETERMINED.
  ...
  record Invalid(String code) implements ClaimNonpaymentReasonCode {
    @Override
