...
public sealed interface ClaimFederalTypeOfServiceCode
    permits ClaimFederalTypeOfServiceCode.Valid, ClaimFederalTypeOfServiceCode.Invalid {
   ...
   */
  static Optional<ClaimFederalTypeOfServiceCode> fromCode(String code) {
    ...
    return Optional.of(
        Arrays.stream(Valid.values())
            ...
            .map(v -> (ClaimFederalTypeOfServiceCode) v)
            .findFirst()
  ...
  record Invalid(String code) implements ClaimFederalTypeOfServiceCode {
    @Override
