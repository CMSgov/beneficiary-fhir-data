...
/** Claim admission source code. */
public sealed interface ClaimAdmissionSourceCode
    permits ClaimAdmissionSourceCode.Valid, ClaimAdmissionSourceCode.Invalid {
   ...
   */
  static Optional<ClaimAdmissionSourceCode> tryFromCode(String code) {
    ...
    return Optional.of(
        Arrays.stream(Valid.values())
            ...
            .map(v -> (ClaimAdmissionSourceCode) v)
            .findFirst()
  ...
  default ExplanationOfBenefit.SupportingInformationComponent toFhir(
    ...
    return supportingInfoFactory
        ...
        .setCode(
            new CodeableConcept()
                .addCoding(
                    new Coding().setSystem(SystemUrls.NUBC_POINT_OF_ORIGIN).setCode(getCode()))
                .addCoding(
                    new Coding()
  ...
  enum Valid implements ClaimAdmissionSourceCode {
    ...
    _2(
        "2",
        "CLINIC OR PHYSICIAN'S OFFICE (NON-NEWBORN)/RESERVED FOR NATIONAL ASSIGNMENT (NEWBORN)"),
    /**
     * 3 - RESERVED FOR NATIONAL ASSIGNMENT (NON-NEWBORN)/RESERVED FOR NATIONAL ASSIGNMENT
     * (NEWBORN).
     */
    _3(
        "3",
    ...
    /**
     * 7 - RESERVED FOR NATIONAL ASSIGNMENT (NON-NEWBORN)/RESERVED FOR NATIONAL ASSIGNMENT
     * (NEWBORN).
     */
    _7(
        "7",
  ...
  record Invalid(String code) implements ClaimAdmissionSourceCode {
    @Override
