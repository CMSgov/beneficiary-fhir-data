...
public class AdjudicationInstitutionalCmsSharedSystems implements AdjudicationEmbedded {
  ...
  @Convert(converter = NonZeroBigDecimalConverter.class)
  private Optional<BigDecimal> totalContractualAmountDiscrepancy;
  ...
  public List<ExplanationOfBenefit.AdjudicationComponent> toFhirAdjudication() {
    return Stream.concat(
            ...
            Stream.of(
                    ...
                    AdjudicationChargeType.COB_PATIENT_RESPONSIBILITY_AMOUNT
                        .toFhirAdjudicationOptional(cobPatientResponsibilityAmount),
                    AdjudicationChargeType.PROVIDER_INTEREST_PAID_AMOUNT.toFhirAdjudicationOptional(
                        providerInterestPaidAmount),
                    AdjudicationChargeType.PROVIDER_OBLIGATION_TO_ACCEPT_AMOUNT
                        .toFhirAdjudicationOptional(providerObligationToAcceptAmount),
                    AdjudicationChargeType.REMAINING_AMOUNT_TO_PROVIDER.toFhirAdjudicationOptional(
                        remainingAmountToProvider),
                    AdjudicationChargeType.TOTAL_CONTRACTUAL_AMOUNT_DISCREPANCY
                        .toFhirAdjudicationOptional(totalContractualAmountDiscrepancy),
