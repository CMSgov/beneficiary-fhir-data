...
import gov.cms.bfd.server.ng.claim.model.common.CarrierLineMTUSIndicatorCode;
import gov.cms.bfd.server.ng.claim.model.common.ClaimPrimaryPayerCode;
import gov.cms.bfd.server.ng.claim.model.common.ClaimProcessingIndicatorCode;
...
@Embeddable
public class ExtensionsProfessionalCmsNch implements ExtensionEmbedded {

  @Embedded ExtensionsProfessionalAllNch allNchExtensions;
  ...
  public List<Extension> toFhir() {
    ...
    return Stream.concat(
            allNchExtensions.toFhir().stream(),
            Stream.of(
                    unitsIndicatorCode.map(CarrierLineMTUSIndicatorCode::toFhir),
                    reducedPaymentPhysicianAssistantCode.map(
                        ReducedPaymentPhysicianAssistantCode::toFhir),
