...
public enum RevenueCenterAnsiReasonCode {
     ...
     */
    _4("4","The procedure code is inconsistent with the modifier used or a required modifier is missing."),
    /**
     ...
     */
    _15("15","Claim/service adjusted because the submitted authorization number is missing, invalid, or does not apply to the billed services or provider."),
    /**
     ...
     */
    _17("17","Claim/service adjusted because requested information was not provided or was insufficient/incomplete."),
    /**
     ...
     */
    _19("19","Claim denied because this is a work-related injury/illness and thus the liability of the Worker's Compensation Carrier."),
    /**
     ...
     */
    _22("22","Claim adjusted because this care may be covered by another payer per coordination of benefits."),
    /**
     ...
     */
    _24("24","Payment for charges adjusted. Charges are covered under a capitation agreement/managed care plan."),
    /**
     ...
     */
    _30("30","Claim/service adjusted because the patient has not met the required eligibility, spend down, waiting, or residency requirements."),
    /**
     ...
     */
    _49("49","These are non-covered services because this is a routine exam or screening procedure done in conjunction with a routine exam."),
    /**
     50 - These are non-covered services because this is not deemed a &#x27;medical necessity&#x27; by the payer.
     */
    _50("50","These are non-covered services because this is not deemed a 'medical necessity' by the payer."),
    /**
     ...
     */
    _52("52","The referring/prescribing/rendering provider is not eligible to refer/prescribe/order/perform the service billed."),
    /**
     ...
     */
    _55("55","Claim/service denied because procedure/treatment is deemed experimental/investigational by the payer."),
    /**
     56 - Claim/service denied because procedure/treatment has not been deemed &#x27;proven to be effective&#x27; by payer.
     */
    _56("56","Claim/service denied because procedure/treatment has not been deemed 'proven to be effective' by payer."),
    /**
     ...
     */
    _57("57","Claim/service adjusted because the payer deems the information submitted does not support this level of service, this many services, this length of service, or this dosage."),
    /**
     ...
     */
    _58("58","Claim/service adjusted because treatment was deemed by the payer to have been rendered in an inappropriate or invalid place of service."),
    /**
     ...
     */
    _60("60","Charges for outpatient services with the proximity to inpatient services are not covered."),
    /**
     ...
     */
    _62("62","Claim/service denied/reduced for absence of, or exceeded, precertification/authorization."),
    /**
     ...
     */
    _88("88","Adjustment amount represents collection against receivable created in prior overpayment."),
    /**
     ...
     */
    _98("98","The hospital must file the Medicare claim for this inpatient non-physician service. INACTIVE"),
    /**
     ...
     */
    _101("101","Predetermination: anticipated payment upon completion of services or claim adjudication."),
    /**
     ...
     */
    _107("107","Claim/service denied because the related or qualifying claim/service was not paid or identified on the claim."),
    /**
     ...
     */
    _109("109","Claim not covered by this payer/contractor. You must send the claim to the correct payer/contractor."),
    /**
     ...
     */
    _112("112","Claim/service adjusted as not furnished directly to the patient and/or not documented."),
    /**
     113 - Claim denied because service/procedure was provided outside the United States or as a result of war.
     */
    _113("113","Claim denied because service/procedure was provided outside the United States or as a result of war."),
    /**
     ...
     */
    _116("116","Claim/service denied. The advance indemnification notice signed by the patient did not comply with requirements."),
    /**
     ...
     */
    _117("117","Claim/service adjusted because transportation is only covered to the closest facility that can provide the necessary care."),
    /**
     ...
     */
    _137("137","Payment/Reduction for Regulatory Surcharges, Assessments, Allowances or Health Related Taxes."),
    /**
     ...
     */
    _141("141","Claim adjustment because the claim spans eligible and ineligible periods of coverage."),
    /**
     ...
     */
    B5("B5","Claim/service adjusted because coverage/program guidelines were not met or were exceeded."),
    /**
     ...
     */
    B6("B6","This service/procedure is adjusted when performed/billed by this type of provider, by this type of facility, or by a provider of this specialty."),
    /**
     B7 - This provider was not certified/eligible to be paid for this procedure/service on this date of service.
     */
    B7("B7","This provider was not certified/eligible to be paid for this procedure/service on this date of service."),
    /**
     B8 - Claim/service not covered/reduced because alternative services were available, and should have been utilized.
     */
    B8("B8","Claim/service not covered/reduced because alternative services were available, and should have been utilized."),
    /**
     ...
     */
    B10("B10","Allowed amount has been reduced because a component of the basic procedure/test was paid. The beneficiary is not liable for more than the charge limit for the basic procedure/test."),
    /**
     ...
     */
    B11("B11","The claim/service has been transferred to the proper payer/processor for processing. Claim/service not covered by this payer/processor."),
    /**
     ...
     */
    B13("B13","Previously paid. Payment for this claim/service may have been provided in a previous payment."),
    /**
     B14 - Claim/service denied because only one visit or consultation per physician per day is covered.
     */
    B14("B14","Claim/service denied because only one visit or consultation per physician per day is covered."),
    /**
     ...
     */
    B17("B17","Claim/service adjusted because this service was not prescribed by a physician, not prescribed prior to delivery, the prescription is incomplete, or the prescription is not current."),
    /**
     B18 - Claim/service denied because this procedure code/modifier was invalid on the date of service or claim submission.
     */
    B18("B18","Claim/service denied because this procedure code/modifier was invalid on the date of service or claim submission."),
    /**
     ...
     */
    B20("B20","Charges adjusted because procedure/service was partially or fully furnished by another provider."),
    /**
     B21 - The charges were reduced because the service/care was partially furnished by another physician. INACTIVE.
     */
    B21("B21","The charges were reduced because the service/care was partially furnished by another physician. INACTIVE"),
    /**
     ...
     */
    B23("B23","Claim/service denied because this provider has failed an aspect of a proficiency testing program."),
    /**
