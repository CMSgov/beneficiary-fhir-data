...
public enum ProfileType {
  ...
  C4BB(
      List.of(SystemUrls.PROFILE_C4BB_PATIENT_2_2_0, SystemUrls.PROFILE_US_CORE_PATIENT_7_0_0),
      List.of(SystemUrls.PROFILE_C4BB_COVERAGE_2_2_0, SystemUrls.PROFILE_US_CORE_COVERAGE_7_0_0)),
