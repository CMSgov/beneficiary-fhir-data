...
public class SecurityLabels {
   ...
   *     associated with that system
   */
  public static Map<String, List<Map<String, Object>>> securityLabelsDict() {
    var inputStream =
   ...
   */
  public static List<String> getSecurityLabelKeys() {
    Map<String, List<Map<String, Object>>> labelsMap = securityLabelsDict();
