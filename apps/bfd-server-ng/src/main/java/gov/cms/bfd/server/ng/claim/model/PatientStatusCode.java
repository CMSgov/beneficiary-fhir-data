...
public sealed interface PatientStatusCode
   ...
   * @return patient status code or empty Optional if code is null or blank
   */
  static Optional<PatientStatusCode> tryFromCode(String code) {
    ...
    return supportingInfoFactory
        ...
        .setCode(
            new CodeableConcept()
                .addCoding(
                    new Coding()
                        .setSystem(SystemUrls.NUBC_PATIENT_DISCHARGE_STATUS)
                        .setCode(getCode()))
                .addCoding(
                    new Coding()
  ...
  enum Valid implements PatientStatusCode {
    ...
    /**
     * 69 - DISCHARGED/TRANSFERRED TO A DESIGNATED DISASTER ALTERNATIVE CARE SITE (EFFECTIVE
     * 10/1/13).
     */
    _69(
        "69",
     ...
     * IN THIS CODE LIST WITH A PLANNED ACUTE CARE HOSPITAL INPATIENT READMISSION (EFFECTIVE
     * 10/1/13).
     */
    _95(
        "95",
  ...
  record Invalid(String code) implements PatientStatusCode {
    @Override
