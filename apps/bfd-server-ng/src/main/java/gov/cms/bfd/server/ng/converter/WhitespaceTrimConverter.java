...
/**
 * Converts any string values into an optional string with leading and trailing whitespace removed.
 */
@Converter
public class WhitespaceTrimConverter implements AttributeConverter<Optional<String>, String> {
  @Override
