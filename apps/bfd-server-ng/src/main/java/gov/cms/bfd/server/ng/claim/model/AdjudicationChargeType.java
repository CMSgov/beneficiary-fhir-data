...
enum AdjudicationChargeType {
  ...
  VACCINATION_ADMIN_FEE(
      SystemUrls.BLUE_BUTTON_CODE_SYSTEM_ADJUDICATION, "CLM_LINE_VCCN_ADMIN_FEE_AMT", "Vaccination Administration Fee"),
  OTHER_AMOUNT(
  ...
  SALES_TAX_AMOUNT(SystemUrls.BLUE_BUTTON_CODE_SYSTEM_ADJUDICATION, "CLM_LINE_SLS_TAX_AMT", "Sales Tax Amount"),
  ...
  LOW_INCOME_COST_SHARE_SUB_AMOUNT(
      SystemUrls.BLUE_BUTTON_CODE_SYSTEM_ADJUDICATION, "CLM_LINE_LIS_AMT", "Low Income Cost Sharing Subsidy Amount"),
  INGREDIENT_COST_AMOUNT(
      SystemUrls.BLUE_BUTTON_CODE_SYSTEM_ADJUDICATION, "CLM_LINE_INGRDNT_CST_AMT", "Ingredient Cost Amount"),
