...
import gov.cms.bfd.server.ng.claim.model.institutional.HhaLupaIndicatorCode;
...
public class HhaLupaIndicatorCodeConverter
    implements AttributeConverter<Optional<HhaLupaIndicatorCode>, String> {
  @Override
