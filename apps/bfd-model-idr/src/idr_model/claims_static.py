...
ADJUDICATED_PROFESSIONAL_CARRIER_CLAIM_TYPES = [71, 72]
ADJUDICATED_PROFESSIONAL_CLAIM_TYPES_DME = [81, 82]
ADJUDICATED_PROFESSIONAL_CLAIM_TYPES = [*ADJUDICATED_PROFESSIONAL_CARRIER_CLAIM_TYPES, *ADJUDICATED_PROFESSIONAL_CLAIM_TYPES_DME]
