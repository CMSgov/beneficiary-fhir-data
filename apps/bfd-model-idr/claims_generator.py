...
def save_output_files(
    ...
    df = pd.json_normalize(cntrct_pbp_num)
    df.to_csv("out/SYNTHETIC_CNTRCT_PBP_NUM.csv", index=False)
    df = pd.json_normalize(cntrct_pbp_cntct)
    df.to_csv("out/SYNTHETIC_CNTRCT_PBP_CNTCT.csv", index=False)
