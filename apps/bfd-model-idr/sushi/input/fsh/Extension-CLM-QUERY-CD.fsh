...
Description: "Deprecated 2026-01-14. Code indicating the type of claim record being processed with respect to payment (debit/credit indicator; interim/final indicator)."
Id: CLM-QUERY-CD 
