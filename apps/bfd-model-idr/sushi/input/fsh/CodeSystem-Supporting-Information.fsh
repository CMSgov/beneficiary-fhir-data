...
* #CLM_MDCR_PRFNL_PRVDR_ASGNMT_SW "Provider Assignment Indicator" "Variable indicates whether or not the provider accepts assignment for the noninstitutional claim."
