...
ADD COLUMN bfd_clm_bnft_svg_ansi_grp_1_cd character varying(2),
ADD COLUMN bfd_clm_bnft_svg_ansi_grp_2_cd character varying(2),
ADD COLUMN bfd_clm_bnft_svg_ansi_grp_3_cd character varying(2),
ADD COLUMN bfd_clm_bnft_svg_ansi_grp_4_cd character varying(2),
ADD COLUMN bfd_clm_bnft_svg_ansi_rsn_1_cd character varying(3),
ADD COLUMN bfd_clm_bnft_svg_ansi_rsn_2_cd character varying(3),
ADD COLUMN bfd_clm_bnft_svg_ansi_rsn_3_cd character varying(3),
