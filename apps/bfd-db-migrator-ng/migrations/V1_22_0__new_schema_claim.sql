...
--  INSTNL   clm_ric_cd                 character varying(1)     NOT NULL,
    ...
    clm_blood_pt_frnsh_qty     integer                  NOT NULL,
...
(
    ...
    bene_sk                    bigint                   NOT NULL,
    clm_cntl_num               character varying(40)    NOT NULL,
--  PAC   clm_orig_cntl_num          character varying(40)    NOT NULL,
    clm_from_dt                date                     NOT NULL,
    clm_thru_dt                date                     NOT NULL,
    clm_efctv_dt               date                     NOT NULL,
    clm_obslt_dt               date                     NOT NULL,
...
--     PAC clm_mdcr_coinsrnc_amt      numeric                  NOT NULL,
--     PAC clm_blood_lblty_amt        numeric                  NOT NULL,
--     PAC clm_ncvrd_chrg_amt         numeric                  NOT NULL,
    clm_mdcr_ddctbl_amt        numeric                  NOT NULL,
    clm_prvdr_pmt_amt          numeric                  NOT NULL,
    clm_alowd_chrg_amt         numeric                  NOT NULL,
    clm_bene_pmt_amt           numeric                  NOT NULL,
...
ALTER TABLE ONLY idr_new.claim_professional_adj
    ADD CONSTRAINT claim_professional_adj_pkey PRIMARY KEY (clm_uniq_id);

ALTER TABLE ONLY idr_new.claim_professional_pac
    ADD CONSTRAINT claim_professional_pac_pkey PRIMARY KEY (clm_uniq_id);
...
--  INSTNL   clm_line_ncvrd_chrg_amt        numeric                  NOT NULL,
    clm_line_prvdr_pmt_amt         numeric                  NOT NULL,
--  INSTNL,PART D   clm_line_bene_pmt_amt          numeric                  NOT NULL,
    clm_line_bene_pd_amt           numeric                  NOT NULL,
    clm_line_cvrd_pd_amt           numeric                  NOT NULL,
--  INSTNL   clm_line_blood_ddctbl_amt      numeric                  NOT NULL,
    clm_line_mdcr_ddctbl_amt       numeric                  NOT NULL,
--  NULL FOR ALL   clm_line_mdcr_coinsrnc_amt     numeric                  NOT NULL,
...
--  INSTNL   clm_line_rev_ctr_cd            character varying(4)     NOT NULL,
    ...
    clm_val_sqnc_num_prod          integer                  NOT NULL,
...
--     idr_updt_ts_prod               timestamp with time zone NOT NULL,
    clm_val_sqnc_num_val           integer                  NOT NULL,
...
--  ADJ  clm_line_pmd_uniq_trkng_num    character varying(14),
    ...
    prvdr_rndrng_prvdr_npi_num  character varying(10)    NOT NULL,
    prvdr_rndrng_sk             bigint                   NOT NULL,
    prvdr_rndrng_hstry_efctv_dt date                     NOT NULL,
    prvdr_rndrng_mdl_name       character varying(25)    NOT NULL,
    prvdr_rndrng_type_cd        character varying(2)     NOT NULL,
    prvdr_rndrng_txnmy_cmpst_cd character varying(150)   NOT NULL,
    prvdr_rndrng_oscar_num      character varying(13)    NOT NULL,
    prvdr_rndrng_1st_name       character varying(35)    NOT NULL,
    prvdr_rndrng_name           character varying(70)    NOT NULL,
    prvdr_rndrng_hstry_obslt_dt date                     NOT NULL,
    prvdr_rndrng_lgl_name       character varying(100)   NOT NULL,
    prvdr_rndrng_emplr_id_num   character varying(10)    NOT NULL,
    prvdr_rndrng_last_name      character varying(35)    NOT NULL,
...
--  ADJ   clm_bene_prmry_pyr_pd_amt      numeric                  NOT NULL,
...
ALTER TABLE ONLY idr_new.claim_item_professional_adj
    ADD CONSTRAINT claim_item_professional_adj_pkey PRIMARY KEY (clm_uniq_id, bfd_row_id);

ALTER TABLE ONLY idr_new.claim_item_professional_pac
    ADD CONSTRAINT claim_item_professional_pac_pkey PRIMARY KEY (clm_uniq_id, bfd_row_id);

--
-- Name: claim; Type: TABLE; Schema: idr; Owner: -
--
...
--     clm_query_cd                 character varying(1)     NOT NULL,
    ...
    clm_pd_dt                  date                     NOT NULL,
    clm_ltst_clm_ind           character varying(1)     NOT NULL,
    prvdr_atndg_prvdr_npi_num  character varying(10)    NOT NULL,
    prvdr_atndg_last_name      character varying(60)    NOT NULL,
    prvdr_atndg_sk             bigint                   NOT NULL,
    prvdr_atndg_hstry_efctv_dt date                     NOT NULL,
    prvdr_atndg_mdl_name       character varying(25)    NOT NULL,
    prvdr_atndg_type_cd        character varying(2)     NOT NULL,
    prvdr_atndg_txnmy_cmpst_cd character varying(150)   NOT NULL,
    prvdr_atndg_oscar_num      character varying(13)    NOT NULL,
    prvdr_atndg_1st_name       character varying(35)    NOT NULL,
    prvdr_atndg_name           character varying(70)    NOT NULL,
    prvdr_atndg_hstry_obslt_dt date                     NOT NULL,
    prvdr_atndg_lgl_name       character varying(100)   NOT NULL,
    prvdr_atndg_emplr_id_num   character varying(10)    NOT NULL,
    prvdr_oprtg_prvdr_npi_num  character varying(10)    NOT NULL,
    prvdr_oprtg_sk             bigint                   NOT NULL,
    prvdr_oprtg_hstry_efctv_dt date                     NOT NULL,
    prvdr_oprtg_mdl_name       character varying(25)    NOT NULL,
    prvdr_oprtg_type_cd        character varying(2)     NOT NULL,
    prvdr_oprtg_txnmy_cmpst_cd character varying(150)   NOT NULL,
    prvdr_oprtg_oscar_num      character varying(13)    NOT NULL,
    prvdr_oprtg_1st_name       character varying(35)    NOT NULL,
    prvdr_oprtg_name           character varying(70)    NOT NULL,
    prvdr_oprtg_hstry_obslt_dt date                     NOT NULL,
    prvdr_oprtg_lgl_name       character varying(100)   NOT NULL,
    prvdr_oprtg_emplr_id_num   character varying(10)    NOT NULL,
    prvdr_oprtg_last_name      character varying(35)    NOT NULL,
    ...
    prvdr_rndrg_prvdr_npi_num  character varying(10)    NOT NULL,
    prvdr_rndrg_sk             bigint                   NOT NULL,
    prvdr_rndrg_hstry_efctv_dt date                     NOT NULL,
    prvdr_rndrg_mdl_name       character varying(25)    NOT NULL,
    prvdr_rndrg_type_cd        character varying(2)     NOT NULL,
    prvdr_rndrg_txnmy_cmpst_cd character varying(150)   NOT NULL,
    prvdr_rndrg_oscar_num      character varying(13)    NOT NULL,
    prvdr_rndrg_1st_name       character varying(35)    NOT NULL,
    prvdr_rndrg_name           character varying(70)    NOT NULL,
    prvdr_rndrg_hstry_obslt_dt date                     NOT NULL,
    prvdr_rndrg_lgl_name       character varying(100)   NOT NULL,
    prvdr_rndrg_emplr_id_num   character varying(10)    NOT NULL,
    prvdr_rndrg_last_name      character varying(35)    NOT NULL,
...
--     clm_sbmtr_cntrct_pbp_num     character varying(3),
    ...
    prvdr_srvc_prvdr_npi_num   character varying(10),
    prvdr_srvc_sk              bigint                   NOT NULL,
    prvdr_srvc_hstry_efctv_dt  date                     NOT NULL,
    prvdr_srvc_mdl_name        character varying(25)    NOT NULL,
    prvdr_srvc_type_cd         character varying(2)     NOT NULL,
    prvdr_srvc_txnmy_cmpst_cd  character varying(150)   NOT NULL,
    prvdr_srvc_oscar_num       character varying(13)    NOT NULL,
    prvdr_srvc_1st_name        character varying(35)    NOT NULL,
    prvdr_srvc_name            character varying(70)    NOT NULL,
    prvdr_srvc_hstry_obslt_dt  date                     NOT NULL,
    prvdr_srvc_lgl_name        character varying(100)   NOT NULL,
    prvdr_srvc_emplr_id_num    character varying(10)    NOT NULL,
    prvdr_srvc_last_name       character varying(35)    NOT NULL,
    clm_blood_chrg_amt         numeric,
...
--     clm_srvc_prvdr_gnrc_id_num   character varying(20)    NOT NULL,
--     prvdr_prscrbng_prvdr_npi_num character varying(10)    NOT NULL,
    idr_insrt_ts_clm           timestamp with time zone NOT NULL,
    idr_updt_ts_clm            timestamp with time zone NOT NULL,
    idr_insrt_ts_dcmtn         timestamp with time zone NOT NULL,
    idr_updt_ts_dcmtn          timestamp with time zone NOT NULL,
    bfd_created_ts             timestamp with time zone NOT NULL,
    bfd_updated_ts             timestamp with time zone NOT NULL,
...
ALTER TABLE ONLY idr_new.claim_institutional_pac
    ADD CONSTRAINT claim_institutional_pac_pkey PRIMARY KEY (clm_uniq_id);

ALTER TABLE ONLY idr_new.claim_institutional_adj
    ADD CONSTRAINT claim_institutional_adj_pkey PRIMARY KEY (clm_uniq_id);
...
--  ADJ   clm_otaf_one_ind_cd         character varying(1)     NOT NULL,
    clm_rev_dscnt_ind_cd        character varying(1)     NOT NULL,
    clm_rev_packg_ind_cd        character varying(1)     NOT NULL,
--  ADJ   clm_rev_cntr_stus_cd        character varying(2)     NOT NULL,
...
--  ADJ   clm_rev_cntr_tdapa_amt      numeric,
...
--  PRFNL   clm_line_dgns_cd               character varying(7)     NOT NULL,
    clm_line_sbmt_chrg_amt         numeric                  NOT NULL,
--  PAC   clm_line_alowd_chrg_amt        numeric                  NOT NULL,
    clm_line_ncvrd_chrg_amt        numeric                  NOT NULL,
    clm_line_prvdr_pmt_amt         numeric                  NOT NULL,
    clm_line_bene_pmt_amt          numeric                  NOT NULL,
    clm_line_bene_pd_amt           numeric                  NOT NULL,
...
ALTER TABLE ONLY idr_new.claim_item_institutional_adj
    ADD CONSTRAINT claim_item_institutional_adj_pkey PRIMARY KEY (clm_uniq_id, bfd_row_id);

ALTER TABLE ONLY idr_new.claim_item_institutional_pac
    ADD CONSTRAINT claim_item_institutional_pac_pkey PRIMARY KEY (clm_uniq_id, bfd_row_id);
...
(
    ...
    clm_cms_proc_dt       date                     NOT NULL,
--     clm_actv_care_from_dt date                     NOT NULL,
--  NON_RX   clm_dschrg_dt         date                     NOT NULL,
    clm_submsn_dt         date                     NOT NULL,
--  NON_RX   clm_ncvrd_from_dt     date                     NOT NULL,
--  NON_RX   clm_ncvrd_thru_dt     date                     NOT NULL,
--     clm_actv_care_thru_dt date                     NOT NULL,
    clm_mdcr_exhstd_dt    date                     NOT NULL,
    clm_nch_wkly_proc_dt  date                     NOT NULL,
...
--  NON_RX   clm_ncvrd_chrg_amt         numeric                  NOT NULL,
--  NON_RX   clm_mdcr_ddctbl_amt        numeric                  NOT NULL,
--  NON_RX   clm_prvdr_pmt_amt          numeric                  NOT NULL,
--  NON_RX   clm_alowd_chrg_amt         numeric                  NOT NULL,
    clm_bene_pmt_amt           numeric                  NOT NULL,
--     clm_cntrctr_num            character varying(5)     NOT NULL,
--     clm_pmt_amt                numeric                  NOT NULL,
    clm_pd_dt                  date                     NOT NULL,
...
--  INSTNL   clm_ric_cd                 character varying(1)     NOT NULL,
--  NON_RX  clm_sbmt_chrg_amt          numeric                  NOT NULL,
--  NON_RX   clm_blood_pt_frnsh_qty     integer                  NOT NULL,
...
--- LINE_ITEM COLUMNS
    ...
    clm_line_ansthsa_unit_cnt      numeric                  NOT NULL,
--  PRFNL   clm_line_dgns_cd               character varying(7)     NOT NULL,
--  NON_RX   clm_line_sbmt_chrg_amt         numeric                  NOT NULL,
--  NON_RX   clm_line_alowd_chrg_amt        numeric                  NOT NULL,
--  INSTNL   clm_line_ncvrd_chrg_amt        numeric                  NOT NULL,
--  NON_RX   clm_line_prvdr_pmt_amt         numeric                  NOT NULL,
    clm_line_bene_pmt_amt          numeric                  NOT NULL,
--  NON_RX   clm_line_bene_pd_amt           numeric                  NOT NULL,
    clm_line_cvrd_pd_amt           numeric                  NOT NULL,
--  INSTNL  clm_line_blood_ddctbl_amt      numeric                  NOT NULL,
--  INSTNL  clm_line_mdcr_ddctbl_amt       numeric                  NOT NULL,
--  NULL FOR ALL   clm_line_mdcr_coinsrnc_amt     numeric                  NOT NULL,
...
--  NON_RX   clm_val_sqnc_num_prod          integer                  NOT NULL,
...
--  NON_RX   clm_val_sqnc_num_val           integer                  NOT NULL,
--  NON_RX   clm_val_cd                     character varying(2)     NOT NULL,
--  NON_RX   clm_val_amt                    numeric                  NOT NULL,
...
ALTER TABLE ONLY idr_new.claim_rx
    ADD CONSTRAINT claim_rx_pkey PRIMARY KEY (clm_uniq_id);