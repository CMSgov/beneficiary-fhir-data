...
def setup_postgres(conn: Connection[DictRow], postgres: PostgresContainer) -> None:
...
def test_pipeline() -> None:
    with PostgresContainer("postgres:16", driver="") as postgres:
        ...
        setup_postgres(conn, postgres)  # type: ignore
        ...
        with (
            ...
            conn.execute(
                ...
                idr_updt_ts=%(timestamp)s WHERE bene_sk = 10464258
                """,
