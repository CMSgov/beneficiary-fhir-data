...
/**
 * <p>
 * This small utility class can be used to process {@link Stream} elements in
 * batches, without violating any of the {@link Stream}'s assumptions about
 * laziness and parallelizability.
 * </p>
 * <p>
 * It was taken from this Stack Overflow answer:
 * <a href="https://stackoverflow.com/a/41748361/1851299">Bruce Hamilton's
 * custom BatchSpliterator</a>.
 * </p>
 */
public final class BatchSpliterator<T> implements Spliterator<List<T>> {
	...
	public static <T> Stream<List<T>> batches(Stream<T> stream, int batchSize) {
		return batchSize <= 0 ? Stream.of(stream.collect(Collectors.toList()))
