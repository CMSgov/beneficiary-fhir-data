 ...
 * </p>
 * <p>
 * Unlike the subclass, the {@link ThreadPoolExecutor#execute(Runnable)} method
 * of the {@link ThreadPoolExecutor} will block in case the queue is full and
 * only unblock when the queue is dequeued - that is a task that is currently in
 * the queue is removed and handled by the {@link ThreadPoolExecutor}.
 * </p>
 * <p>
 ...
 * once the queue is full, but the {@link BlockingThreadPoolExecutor}
...
public final class BlockingThreadPoolExecutor extends ThreadPoolExecutor {
	 ...
	 */
	public BlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime,
	 ...
	 *            is the unit of time to use with the previous parameter.
	 */
	public BlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime, TimeUnit unit) {
		super(poolSize, // Core size
				poolSize, // Max size
				keepAliveTime, unit,
				// not smaller than the poolSize (to avoid redundant threads)
	 ...
	 * {@link BlockingThreadPoolExecutor}. It does so by invoking the
