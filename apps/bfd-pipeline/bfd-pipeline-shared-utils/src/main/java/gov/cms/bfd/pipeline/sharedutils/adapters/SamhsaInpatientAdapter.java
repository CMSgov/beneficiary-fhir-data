...
public class SamhsaInpatientAdapter extends SamhsaAdapterBase<InpatientClaim, InpatientClaimLine> {
  ...
  Map<Supplier<Optional<String>>, String> getClaimLineMethods(
      InpatientClaimLine inpatientClaimLine) {
    return Map.ofEntries(entry(inpatientClaimLine::getHcpcsCode, "hcpcs_cd"));
  }

  /** {@inheritDoc} */
  @Override
  Short getLineNum(InpatientClaimLine inpatientClaimLine) {
    return inpatientClaimLine.getLineNumber();
  }
  ...
  Map<Supplier<Optional<String>>, String> getClaimMethods() {
    return Map.ofEntries(
        ...
        entry(claim::getDiagnosisExternal11Code, "icd_dgns_e_cd12"),
