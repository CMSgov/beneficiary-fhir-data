...
/** Unit tests for {@link gov.cms.bfd.pipeline.rif.extract.RifFilesProcessor}. */
public final class RifFilesProcessorTest {
  ...
  public void process1MedicareBeneficiaryIdHistoryRecord() {
    ...
    Assert.assertEquals("567834", medicareBeneficiaryIdHistory.getBeneficiaryId().get());
    Assert.assertEquals(
  ...
  public void process1DMEClaimRecord() {
    ...
    Assert.assertEquals("49035044700", claimLine.getNationalDrugCode().get());
    Assert.assertEquals("000000000", claimLine.getClmControlNumber());
  }
