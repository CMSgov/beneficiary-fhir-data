...
/** Integration tests for {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorWorker}. */
public final class DataSetMonitorWorkerIT {
  ...
  /**
   * Tests {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorWorker} when run against an
   * empty bucket.
   */
  @Test
  ...
  /**
   * Tests {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorWorker} when run against a
   * bucket with a single data set.
   */
  @Test
  ...
  /**
   * Tests {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorWorker} when run against a
   * bucket with a single data set that should be skipped (per {@link
   * ExtractionOptions#getDataSetFilter()}).
   */
  @Test
