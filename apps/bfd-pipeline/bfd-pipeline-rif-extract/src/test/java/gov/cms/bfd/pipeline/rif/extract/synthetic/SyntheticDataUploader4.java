...
import gov.cms.bfd.pipeline.rif.extract.synthetic.SyntheticDataFixer4.SyntheticDataFile;
...
/**
 * Small one-off helper app that uploads the synthetic data from {@link SyntheticDataFixer4} to the
 * appropriate place in S3.
 */
public final class SyntheticDataUploader4 {
  private static final Logger LOGGER = LoggerFactory.getLogger(SyntheticDataUploader4.class);

  /**
   * Pushes the synthetic data from {@link SyntheticDataFixer4} up to S3, replacing any versions
