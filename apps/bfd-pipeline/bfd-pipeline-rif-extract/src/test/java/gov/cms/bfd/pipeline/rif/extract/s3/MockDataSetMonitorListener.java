...
final class MockDataSetMonitorListener implements DataSetMonitorListener {
	...
	/**
	 * @see gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorListener#dataAvailable(gov.cms.bfd.pipeline.rif.model.RifFilesEvent)
	 */
	@Override
	...
	/**
	 * @see gov.cms.bfd.pipeline.rif.extract.s3.DataSetMonitorListener#errorOccurred(java.lang.Throwable)
	 */
	@Override
