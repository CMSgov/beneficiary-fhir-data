...
/** Unit tests for {@link gov.cms.bfd.pipeline.rif.extract.CsvRecordGroupingIterator}. */
public class CsvRecordGroupingIteratorTest {
  /**
   * Tests {@link gov.cms.bfd.pipeline.rif.extract.CsvRecordGroupingIterator} in a scenario that
   * should result in single-record groups.
   *
  ...
  /**
   * Tests {@link gov.cms.bfd.pipeline.rif.extract.CsvRecordGroupingIterator} in a scenario that
   * should result in two-record groups.
   *
   * @throws IOException (indicates a test failure)
   */
  @Test
