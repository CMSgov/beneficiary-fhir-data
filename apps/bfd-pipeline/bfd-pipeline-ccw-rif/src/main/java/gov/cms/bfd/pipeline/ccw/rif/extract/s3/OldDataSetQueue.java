...
public final class OldDataSetQueue {
  private static final Logger LOGGER = LoggerFactory.getLogger(OldDataSetQueue.class);
  ...
  /**
   * Constructs a new {@link OldDataSetQueue} instance.
   *
   ...
   * data sets in this {@link OldDataSetQueue}.
   *
