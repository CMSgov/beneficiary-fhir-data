...
import gov.cms.bfd.pipeline.ccw.rif.extract.synthetic.SyntheticDataFixer2.SyntheticDataFile;
...
/**
 * Small one-off helper app that uploads the synthetic data from {@link SyntheticDataFixer2} to the
