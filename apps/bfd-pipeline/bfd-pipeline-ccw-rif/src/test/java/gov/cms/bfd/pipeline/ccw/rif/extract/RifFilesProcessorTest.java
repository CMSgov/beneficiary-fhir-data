...
public final class RifFilesProcessorTest {
  ...
  public void process1BeneRecord() {
    ...
    Assert.assertEquals(GOLDEN_BENE_ID, beneRow.getBeneficiaryId());
  ...
  public void processBeneficiaryHistoryRecord_SAMPLE_A() {
    ...
    Assert.assertEquals(GOLDEN_BENE_ID, beneficiaryHistory0.getBeneficiaryId());
    ...
    for (RifRecordEvent<?> rifRecordEvent :
      ...
      Assert.assertEquals(RecordAction.INSERT, rifRecordEvent.getRecordAction());
      Assert.assertEquals(GOLDEN_BENE_ID, beneficiaryHistory.getBeneficiaryId());
  ...
  public void process1MedicareBeneficiaryIdHistoryRecord() {
    ...
    Assert.assertEquals(GOLDEN_BENE_ID, medicareBeneficiaryIdHistory.getBeneficiaryId().get());
    Assert.assertEquals(
        LocalDate.of(2011, Month.APRIL, 16),
        medicareBeneficiaryIdHistory.getMbiEffectiveDate().get());
    Assert.assertEquals(
        "9AB2WW3GR44", medicareBeneficiaryIdHistory.getMedicareBeneficiaryId().get());
  }
  ...
  public void processBeneRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_BENES.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
  ...
  public void process1PDERecord() {
    ...
    Assert.assertEquals(GOLDEN_BENE_ID, pdeRow.getBeneficiaryId());
    ...
    Assert.assertEquals("495800192", pdeRow.getNationalDrugCode());
    ...
    Assert.assertEquals(
        new BigDecimal("42.42"), pdeRow.getPatientLiabilityReductionOtherPaidAmount());
  ...
  public void processPDERecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_PDE.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_PDE.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1CarrierClaimRecord() {
    ...
    Assert.assertEquals(GOLDEN_BENE_ID, claimGroup.getBeneficiaryId());
  ...
  public void processCarrierClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_CARRIER.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_CARRIER.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1InpatientClaimRecord() {
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_A_INPATIENT.getRecordCount(), rifEventsList.size());
    ...
    Assert.assertEquals(
        new BigDecimal("0"), claimGroup.getClaimPPSOldCapitalHoldHarmlessAmount().get());
    ...
    Assert.assertEquals(
        new BigDecimal("23.99"), claimGroup.getDrgOutlierApprovedPaymentAmount().get());
  ...
  public void processInpatientClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_INPATIENT.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_INPATIENT.getRecordCount(), rifEventsList.size());
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_INPATIENT.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1OutpatientClaimRecord() {
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_A_OUTPATIENT.getRecordCount(), rifEventsList.size());
    ...
    Assert.assertFalse(claimLine.getHcpcsSecondModifierCode().isPresent());
    Assert.assertEquals(
        new BigDecimal("10.45"), claimGroup.getLines().get(0).getBloodDeductibleAmount());
    Assert.assertEquals(
        new BigDecimal("12.89"), claimGroup.getLines().get(0).getCashDeductibleAmount());
  ...
  public void processOutpatientClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_OUTPATIENT.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_OUTPATIENT.getRecordCount(), rifEventsList.size());
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_OUTPATIENT.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1SNFClaimRecord() {
    ...
    Assert.assertEquals(
        new BigDecimal("5.00"), claimGroup.getClaimPPSCapitalExceptionAmount().get());
    Assert.assertEquals(
    ...
    Assert.assertEquals(
        LocalDate.of(2002, 1, 31), claimGroup.getMedicareBenefitsExhaustedDate().get());
  ...
  public void processSNFClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_SNF.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_SNF.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void processHospiceClaimRecords() {
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_HOSPICE.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1HHAClaimRecord() {
    ...
    Assert.assertEquals(new BigDecimal("26.00"), claimGroup.getLines().get(0).getPaymentAmount());
    Assert.assertEquals(
        new BigDecimal("24.00"), claimGroup.getLines().get(0).getNonCoveredChargeAmount());
    Assert.assertEquals(
  ...
  public void processHHAClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_HHA.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_HHA.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
  ...
  public void process1DMEClaimRecord() {
    ...
    Assert.assertEquals("495800192", claimLine.getNationalDrugCode().get());
  }
  ...
  public void processDMEClaimRecords() {
    RifFilesEvent filesEvent =
        new RifFilesEvent(Instant.now(), StaticRifResource.SAMPLE_B_DME.toRifFile());
    RifFilesProcessor processor = new RifFilesProcessor();
    RifFileRecords rifFileRecords = processor.produceRecords(filesEvent.getFileEvents().get(0));
    List<RifRecordEvent<?>> rifEventsList =
        rifFileRecords.getRecords().collect(Collectors.toList());
    ...
    Assert.assertEquals(
        StaticRifResource.SAMPLE_B_DME.getRifFileType(),
        rifEventsList.get(0).getFileEvent().getFile().getFileType());
  }
}
