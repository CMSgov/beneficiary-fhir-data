...
import gov.cms.bfd.pipeline.ccw.rif.extract.synthetic.SyntheticDataFixer3.SyntheticDataFile;
...
/**
 * Small one-off helper app that uploads the synthetic data from {@link SyntheticDataFixer3} to the
