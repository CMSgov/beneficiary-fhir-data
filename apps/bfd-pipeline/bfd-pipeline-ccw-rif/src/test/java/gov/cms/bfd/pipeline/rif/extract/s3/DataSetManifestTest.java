...
/** Unit tests for {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetManifest}. */
public final class DataSetManifestTest {
  /**
   * Verifies that {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetManifest} can be unmarshalled,
   * as expected.
   *
  ...
  /**
   * Verifies that {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetManifest} can be unmarshalled,
   * as expected. The sample XML document used here was produced by Scott Koerselman on 2016-12-19.
   *
   * @throws JAXBException (indicates test failure)
   */
  @Test
  ...
  /**
   * Verifies that {@link gov.cms.bfd.pipeline.rif.extract.s3.DataSetManifest} can be unmarshalled,
   * as expected, even when the <code>
  ...
  /**
   * Just a simple little app that will use JAXB to marshall a sample {@link
   * gov.cms.bfd.pipeline.rif.extract.s3.DataSetManifest} to XML. This was used as the basis for the
   * test resources used in these tests.
   *
   * @param args (not used)
