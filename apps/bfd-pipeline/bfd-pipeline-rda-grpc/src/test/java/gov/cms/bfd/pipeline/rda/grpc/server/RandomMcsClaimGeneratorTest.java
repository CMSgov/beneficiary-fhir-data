  ...
  public void randomClaim() throws InvalidProtocolBufferException {
    ...
    assertEquals(
        "{\n"
            ...
            + "    \"idrKPosLnameOrg\": \"schkjtsdcjmrtggtbqzrdqrmkbvfxh\",\n"
            + "    \"idrKPosFname\": \"vxzgbvnvjhrcsjpr\",\n"
            + "    \"idrKPosMname\": \"jgnkkxdtrjgjpbvcddm\",\n"
            + "    \"idrKPosAddr1\": \"b7qhvqh3c96zdpt8521vrb9sdtkrmm3q85tsrxk06k\",\n"
            + "    \"idrKPosAddr21st\": \"6xr\",\n"
            + "    \"idrKPosAddr22nd\": \"z5gm0xt8m1f\",\n"
            + "    \"idrKPosCity\": \"cgdbbtckhsxgghqkzchskzftknktff\",\n"
            + "    \"idrKPosState\": \"x\",\n"
            ...
            + "    \"idrKPosLnameOrg\": \"rsgvhgdjqqqtzssmznctfdpkqbzzdv\",\n"
            + "    \"idrKPosFname\": \"zfmbnjgccvrwphbnjzzmrsffkt\",\n"
            + "    \"idrKPosMname\": \"hppzpnqdgpndhjstrwhkgxc\",\n"
            + "    \"idrKPosAddr1\": \"9wtf9874v7njdfftt5hq678b792\",\n"
            + "    \"idrKPosAddr21st\": \"0qkrpj787q5gc2\",\n"
            + "    \"idrKPosAddr22nd\": \"030hphj5rzf479sb7zmkp5\",\n"
            + "    \"idrKPosCity\": \"vxrxjwxzdmxgrfdgxmvbrq\",\n"
            + "    \"idrKPosState\": \"q\",\n"
            + "    \"idrKPosZip\": \"15450353\"\n"
            + "  }],\n"
