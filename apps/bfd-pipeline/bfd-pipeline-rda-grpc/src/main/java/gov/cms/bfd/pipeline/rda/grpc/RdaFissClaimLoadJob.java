 ...
 * is a simple wrapper to ensure that PartAdjFissClaim processing has a unique PipelineJobType value
 * based on its class.
 */
public class RdaFissClaimLoadJob extends AbstractRdaLoadJob<RdaChange<PartAdjFissClaim>> {
  private static final Logger LOGGER = LoggerFactory.getLogger(RdaFissClaimLoadJob.class);

  public RdaFissClaimLoadJob(
      Config config,
      Callable<RdaSource<RdaChange<PartAdjFissClaim>>> sourceFactory,
      Callable<RdaSink<RdaChange<PartAdjFissClaim>>> sinkFactory,
