...
/**
 * Transforms a gRPC FissClaim object into a Hibernate PartAdjFissClaim object. Note that the gRPC
 ...
 * present. All other fields are validated and copied into a new PartAdjFissClaim object. A
...
public class FissClaimTransformer {
  ...
  public FissClaimTransformer(Clock clock, IdHasher idHasher) {
    ...
    PartAdjFissClaim_servTypeCdForSpecialFacilities_Extractor =
        new EnumStringExtractor<>(
            ...
            ImmutableSet.of(),
            ImmutableSet.of());
    PartAdjFissClaim_freqCd_Extractor =
        new EnumStringExtractor<>(
  ...
  private PartAdjFissClaim transformMessageImpl(
    ...
    transformer.copyEnumAsCharacter(
        ...
        PartAdjFissClaim_currStatus_Extractor.getEnumString(from),
        to::setCurrStatus);
    transformer.copyEnumAsCharacter(
        namePrefix + PartAdjFissClaim.Fields.currLoc1,
        PartAdjFissClaim_currLoc1_Extractor.getEnumString(from),
        to::setCurrLoc1);
    transformer.copyEnumAsString(
        ...
        1,
        5,
        PartAdjFissClaim_currLoc2_Extractor.getEnumString(from),
        to::setCurrLoc2);
    ...
    transformer.copyOptionalString(
        ...
        to::setNpiNumber);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissClaim.Fields.mbi, 1, 13, from::hasMbi, from::getMbi, to::setMbi);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissClaim.Fields.mbiHash,
        1,
        64,
        from::hasMbi,
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_lobCd_Extractor.getEnumString(from),
        to::setLobCd);
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_servTypeCd_Extractor.getEnumString(from),
        to::setServTypeCd);
    transformer.copyEnumAsString(
        namePrefix + PartAdjFissClaim.Fields.servTypeCd,
        true,
        1,
        1,
        PartAdjFissClaim_servTypeCdForClinics_Extractor.getEnumString(from),
        to::setServTypeCd);
    transformer.copyEnumAsString(
        namePrefix + PartAdjFissClaim.Fields.servTypeCd,
        true,
        1,
        1,
        PartAdjFissClaim_servTypeCdForSpecialFacilities_Extractor.getEnumString(from),
        to::setServTypeCd);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissClaim.Fields.servTypeCd,
        1,
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_freqCd_Extractor.getEnumString(from),
        to::setFreqCd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_adjReqCd_Extractor.getEnumString(from),
        to::setAdjReqCd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_cancAdjCd_Extractor.getEnumString(from),
        to::setCancAdjCd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_admSource_Extractor.getEnumString(from),
        to::setAdmSource);
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_primaryPayerCode_Extractor.getEnumString(from),
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_attendPhysFlag_Extractor.getEnumString(from),
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_operPhysFlag_Extractor.getEnumString(from),
        to::setOperPhysFlag);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_othPhysFlag_Extractor.getEnumString(from),
        to::setOthPhysFlag);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_procNewHicInd_Extractor.getEnumString(from),
        to::setProcNewHicInd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_reposInd_Extractor.getEnumString(from),
        to::setReposInd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_mbiSubmBeneInd_Extractor.getEnumString(from),
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissClaim_adjMbiInd_Extractor.getEnumString(from),
        to::setAdjMbiInd);
    transformer.copyOptionalString(
  ...
  private PartAdjFissDiagnosisCode transformMessageImpl(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissDiagnosisCode_diagPoaInd_Extractor.getEnumString(from),
        to::setDiagPoaInd);
    transformer.copyOptionalString(
  ...
  private PartAdjFissPayer transformMessageImpl(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_insuredPayer_payersId_Extractor.getEnumString(from),
        to::setPayersId);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_insuredPayer_relInd_Extractor.getEnumString(from),
        to::setRelInd);
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_insuredPayer_assignInd_Extractor.getEnumString(from),
        to::setAssignInd);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        2,
        PartAdjFissPayer_insuredPayer_insuredRel_Extractor.getEnumString(from),
        to::setInsuredRel);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_insuredPayer_insuredSex_Extractor.getEnumString(from),
        to::setInsuredSex);
    transformer.copyEnumAsString(
        ...
        1,
        2,
        PartAdjFissPayer_insuredPayer_insuredRelX12_Extractor.getEnumString(from),
        to::setInsuredRelX12);
    transformer.copyOptionalDate(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_beneZPayer_payersId_Extractor.getEnumString(from),
        to::setPayersId);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissPayer.Fields.payersName,
        1,
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_beneZPayer_relInd_Extractor.getEnumString(from),
        to::setRelInd);
    transformer.copyEnumAsString(
        namePrefix + PartAdjFissPayer.Fields.assignInd,
        true,
        1,
        1,
        PartAdjFissPayer_beneZPayer_assignInd_Extractor.getEnumString(from),
        to::setAssignInd);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissPayer.Fields.providerNumber,
        1,
    ...
    transformer.copyEnumAsString(
        ...
        1,
        2,
        PartAdjFissPayer_beneZPayer_beneRel_Extractor.getEnumString(from),
        to::setBeneRel);
    transformer.copyOptionalString(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_beneZPayer_beneSex_Extractor.getEnumString(from),
        to::setBeneSex);
    transformer.copyOptionalString(
        namePrefix + PartAdjFissPayer.Fields.treatAuthCd,
        1,
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissPayer_beneZPayer_insuredSex_Extractor.getEnumString(from),
        to::setInsuredSex);
    transformer.copyEnumAsString(
        namePrefix + PartAdjFissPayer.Fields.insuredRelX12,
        true,
        1,
        2,
        PartAdjFissPayer_beneZPayer_insuredRelX12_Extractor.getEnumString(from),
        to::setInsuredRelX12);
    to.setLastUpdated(now);
    return to;
  }
  ...
  private PartAdjFissAuditTrail transformMessageImpl(
    ...
    transformer.copyEnumAsString(
        ...
        1,
        1,
        PartAdjFissAuditTrail_badtStatus_Extractor.getEnumString(from),
        to::setBadtStatus);
    transformer.copyOptionalString(
