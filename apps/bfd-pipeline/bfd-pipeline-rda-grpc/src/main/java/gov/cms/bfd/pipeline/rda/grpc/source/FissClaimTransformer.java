...
/**
 * Transforms a gRPC FissClaim object into a Hibernate {@link PartAdjFissClaim} object. Note that
 * the gRPC data objects are not proper java beans since their optional field getters should only be
 * called if their corresponding &quot;has&quot; methods return true. Optional fields are ignored
 * when not present. All other fields are validated and copied into a new {@link PartAdjFissClaim}
