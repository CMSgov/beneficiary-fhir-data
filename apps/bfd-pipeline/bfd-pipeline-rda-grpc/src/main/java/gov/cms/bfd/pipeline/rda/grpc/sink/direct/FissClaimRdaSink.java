...
public class FissClaimRdaSink extends AbstractClaimRdaSink<FissClaimChange, PartAdjFissClaim> {
  ...
  @Nonnull
  @Override
  public RdaChange<PartAdjFissClaim> transformMessage(String apiVersion, FissClaimChange message) {
  ...
  @Override
  RdaApiClaimMessageMetaData createMetaData(RdaChange<PartAdjFissClaim> change) {
    final PartAdjFissClaim claim = change.getClaim();
