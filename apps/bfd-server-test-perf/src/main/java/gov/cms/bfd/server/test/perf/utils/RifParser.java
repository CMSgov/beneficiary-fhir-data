...
public class RifParser {
	 ...
	 * 
	 * @param rifFile
	 * 		The RIF file to manage with this class
	 */
	 ...
	 * 
	 * @param rifFileName
	 * 		RIF file name to manage with this class
	 * @param rifFileType
	 * 		The type of the RIF file to manage
	 * @throws URISyntaxException
	 * 		Thrown if there is an error parsing the RIF file name
	 */
	 ...
	 * 
	 * @return 
	 * 		{@link RifRecordEvent} or null if none found
	 */
