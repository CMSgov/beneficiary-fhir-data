...
public final class FhirClient {
	...
	public static IGenericClient create(String fhirServerUrlText, String clientKeystoreDirText, String proxyHost,
			int proxyPort) {
		...
		try {
			...
			if (proxyHost != null) { // configuration with proxy
				defaultRequestConfig = RequestConfig.custom()
						...
						.setProxy(new HttpHost(proxyHost, proxyPort)).setStaleConnectionCheckEnabled(true).build();
