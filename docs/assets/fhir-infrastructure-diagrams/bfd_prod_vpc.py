...
with Diagram(
    ...
    with Cluster(label="bfd-prod-vpc"):
        ...
        with Cluster("DMZ Layer"), Cluster("bfd-prod-az(1,2,3)-dmz"):
            with Cluster("Public Subnet"):
                elb = ELB("Prod ELB")
        with Cluster("Application Layer"):
            with Cluster("brd-prod-az1-app"), Cluster("Private Subnet"):
                server1 = EC2("bfd-prod-fhir-ap1")
            with Cluster("brd-prod-az2-app"), Cluster("Private Subnet"):
                server2 = EC2("bfd-prod-fhir-ap2")
            with Cluster("brd-prod-az3-app"), Cluster("Private Subnet"):
                server3 = EC2("bfd-prod-fhir-ap3")
        with Cluster("Data Layer"):
            with Cluster("bfd-prod-az1-data"), Cluster("Private Subnet"):
                db1 = Aurora("bfd-prod-replica1")
            with Cluster("bfd-prod-az2-data"), Cluster("Private Subnet"):
            ...
            with Cluster("bfd-prod-az3-data"), Cluster("Private Subnet"):
