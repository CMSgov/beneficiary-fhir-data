...
public final class DataSetMonitor {
	...
	/**
	 * @return <code>true</code> if this {@link DataSetMonitor} is running,
	...
	private static final class ErrorNotifyingRunnableWrapper implements Runnable {
		 ...
		 */
		public ErrorNotifyingRunnableWrapper(Runnable wrappedRunnable, DataSetMonitorListener listener) {
