...
/**
 * Models a {@link Stream} of {@link RifFileRecords}, produced from a single
 * {@link RifFile} in a {@link RifFilesEvent}.
 */
public final class RifFileRecords {
	 ...
	 * 
	 * @param sourceEvent
	 *            the value to use for {@link #getSourceEvent()}
	 * @param records
	 *            the value to use for {@link #getRecords()}
	 */
	...
	/**
	 * @return the {@link RifFileEvent} that the {@link #getRecords()}
	 *         {@link Stream} was produced from
	 */
	...
	/**
	 * @return the {@link Stream} of {@link RifRecordEvent}s that was produced
	 *         from the {@link RifFile}
	 */
