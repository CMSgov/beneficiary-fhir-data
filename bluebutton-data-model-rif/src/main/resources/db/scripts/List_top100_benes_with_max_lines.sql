/*
 * Calculate each beneficiary's total number of claims and claim lines.
 * 
 ...
 * 
 * 1. Allows one to select good/useful beneficiaries to test against, depending
 *    on how much data one wants to be getting back.
 * 2. Assists in determining what the system's performance characteristics are
 *    and/or need to be.
 */
