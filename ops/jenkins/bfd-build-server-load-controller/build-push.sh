...
IMAGE_NAME_NODE="${PRIVATE_REGISTRY_URI}/bfd-mgmt-server-load-controller"
SSM_IMAGE_TAG_NODE="/bfd/mgmt/server/nonsensitive/server_load_controller_latest_image_tag"
