...
DOCKER_TAG="${CBC_DOCKER_TAG:-"jdk17-mvn3-tfenv3-${GIT_SHORT_HASH}"}"
DOCKER_TAG_LATEST="${CBC_DOCKER_TAG_LATEST:-"jdk17-mvn3-tfenv3-latest"}"
...
docker build . \
  ...
  --build-arg PYTHON3_TAR_SOURCE="${PYTHON3_TAR_SOURCE:-https://www.python.org/ftp/python/3.9.16/Python-3.9.16.tgz}" \
