{
    "widgets": [
            ...
            "type": "text",
            "properties": {
                "markdown": "#BFD-Pipeline OpenTelemtry Metrics\n---\n"
            }
        },
        {
            "height": 6,
            ...
            "properties": {
                ...
                "title": "BFD-Pipeline Dropwizard Heap"
            }
        },
        {
            "height": 3,
            ...
            "properties": {
                ...
                "stacked": false,
                "region": "us-east-1",
                "title": "BFD-Pipeline hikaricp-3.0  DB Client Connections",
                "stat": "Average",
                "period": 300,
        ...
        },
        {
            ...
            "properties": {
                ...
                "stacked": true,
                "region": "us-east-1",
                "title": "BFD-Pipeline Dropwizard G1 Young/Old Count",
                "stat": "Average",
                "period": 300,
                "singleValueFullPrecision": false,
                "metrics": [
        ...
        },
        {
            ...
            "properties": {
                ...
                "region": "us-east-1",
                "title": "BFD-Pipeline Hikari Pool Connections"
            }
        },
        {
            "height": 6,
            ...
            "properties": {
                ...
                "title": " BFD-Pipeline HikariPool-1.pool.Usage, HikariPool-1.pool.Wait"
            }
        },
        {
            "height": 3,
            ...
            "properties": {
                ...
                "title": "BFD-Pipeline http.client.duration, http.server.active_requests, http.server.duration"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "title": "BFD-Pipeline Dropwizard non-heap"
            }
        },
        {
            "height": 25,
        ...
        },
        {
            ...
            "properties": {
                ...
                "title": "BFD-Pipeline total.committed, total.init, total.max, total.used"
            }
        },
        {
            "height": 5,
        ...
        },
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "region": "us-east-1",
                "title": "BFD-Pipeline Dropwizard non-heap usage",
                "stat": "Average",
                "period": 300,
                "singleValueFullPrecision": false,
                "setPeriodToTimeRange": false,
        ...
        },
        {
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 300,
                "title": "BFD-Pipeline Dropwizard Compressed Class Space"
            }
        },
        {
            "height": 25,
            ...
            "properties": {
                ...
                "stacked": false,
                "region": "us-east-1",
                "title": "BFD-Pipeline Pools Usage",
                "stat": "Average",
                "period": 300,
                "singleValueFullPrecision": false,
                "setPeriodToTimeRange": false,
        ...
        },
        {
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 300,
                "title": "BFD-Pipeline Dropwizard Pools G1-Eden"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 300,
                "title": "BFD-Pipeline Dropwizard Pools Survivor"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 300,
                "title": "BFD-Pipeline Dropwizard Pools G1-Old"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 300,
                "title": "BFD-Pipeline Dropwizard Pools Metaspace"
            }
        }
    ]
}