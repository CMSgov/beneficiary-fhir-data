variable "environment_name" {
  ...
  type        = string
  validation {
    // NOTE: validations can only refer to this scope, i.e. `var.environment_name` is valid but `local.established_envs`
    ...
    error_message = "Invalid evironment/workspace name. https://github.com/CMSgov/beneficiary-fhir-data/wiki/Environments#ephemeral-environments for more details."
  }
}
