    ...
    "widgets": [
        {
            ...
            "properties": {
                ...
                [button:SLI Dashboard]([https://us-east-1.console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=bfd-migrator-${env})\n
                [button:BFD Application Log Metrics]([https://us-east-1.console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=bfd-migrator-${env})\n
                [button:Host Metrics]([https://us-east-1.console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=bfd-migrator-${env})\n
                [button:AWS Service Dashboards]([https://us-east-1.console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=bfd-migrator-${env})\n
                [button:OpenTelemetry Metrics]([https://us-east-1.console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=bfd-migrator-${env})\n\n:"
                }
        },
        {
            "height": 1,
