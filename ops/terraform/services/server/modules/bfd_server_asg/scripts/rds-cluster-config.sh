...
PROXY_READER_ENDPOINT="$(aws rds describe-db-proxy-endpoints --db-proxy-name bfd-3495-test | jq -r '.DBProxyEndpoints[] | select(.TargetRole | contains("READ_ONLY")) | .Endpoint')"
