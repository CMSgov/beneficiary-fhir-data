...
The process is outlined in this [Runbook](https://github.com/CMSgov/beneficiary-fhir-data/wiki/how-to-load-cloudwatch-historical-data#how-to-load-cloudwatch-historical-data).
...
Please see the
["How to Create BFD Insights QuickSight"](https://github.com/CMSgov/beneficiary-fhir-data/wiki/how-to-create-bfd-insights-quicksight)
