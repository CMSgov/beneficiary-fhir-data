        ...
        "blocks": [
            {
                ...
                "text": {
                    ...
                    "text": (
                        ...
                        f"For help troubleshooting, reference the following <https://github.com/CMSgov/beneficiary-fhir-data/wiki/how-to-investigate-firehose-ingestion-processing-failures#how-to-investigate-firehose-ingestion-processing-failures|runbook>\n"
                    ),
                },
            }
        ]
