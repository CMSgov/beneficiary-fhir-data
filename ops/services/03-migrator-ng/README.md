...
This subfolder contains the Terraform configuration (Task Definitions, ECS Service definitions, run scripts, etc.) for the BFD v3 Migrator ECS Task and all related infrastructure.
