...
This subdirectory contains the Python source code for the `consume-idr-events` Lambda and the container image definitions (`Dockerfile` and `Dockerfile.dockerignore`) for the `bfd-platform-consume-idr-events` image.
