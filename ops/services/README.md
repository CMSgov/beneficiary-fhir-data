...
This configures what Terraservice you are in to point to the corresponding AWS Account state Bucket (OpenTofu state is managed via a bucket), then switches to the correct Workspace.
