# `idr-pipeline-alarms` Service

This subfolder contains the Terraform configuration for Alarms related to the IDR Pipeline.
...
| `config` | Yes | Yes | N/A |
| `cluster` | Yes | Yes | N/A |
| `idr-pipeline-metrics` | Yes | Yes | N/A |
...
| [aws_cloudwatch_metric_alarm.log_availability_24hr](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_metric_alarm) | resource |
