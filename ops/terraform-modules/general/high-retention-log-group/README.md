...
| <a name="input_skip_destroy"></a> [skip\_destroy](#input\_skip\_destroy) | Set true to skip destroying the log group. | `bool` | `true` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the CloudWatch log group created by this module. |
| <a name="output_log_group"></a> [log\_group](#output\_log\_group) | `aws_cloudwatch_log_group` resource created by this module. |
| <a name="output_name"></a> [name](#output\_name) | Name of the CloudWatch log group created by this module. |
<!-- END_TF_DOCS -->
