...
copy_params \
  ...
  "${base_path}/nonsensitive/pac/resources_enabled" "${base_config_path}/bfdServer.pac.enabled"

copy_secure_params \
  "${base_path}/sensitive/db/username" "${base_config_path}/bfdServer.db.username" \
  "${base_path}/sensitive/db/password" "${base_config_path}/bfdServer.db.password" \
  "${base_path}/sensitive/port" "${base_config_path}/BFD_PORT" \
  "${base_path}/sensitive/new_relic/metrics/license_key" "${base_config_path}/NEW_RELIC_METRIC_KEY"
...
#     NEW_RELIC_LICENSE_KEY  ${base_path}/sensitive/new_relic/agent/license_key
